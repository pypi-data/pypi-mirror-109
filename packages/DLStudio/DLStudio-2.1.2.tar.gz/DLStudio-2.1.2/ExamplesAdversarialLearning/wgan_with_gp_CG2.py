...
wgan =   AdversarialLearning.DataModeling( dlstudio = dls, advers = advers )
...
wgan.run_wgan_with_gp_code(dls, advers, critic=critic, generator=generator, results_dir="results_WGAN_with_gp")
