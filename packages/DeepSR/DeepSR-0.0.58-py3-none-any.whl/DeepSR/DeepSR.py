...
if mod_name == "DeepSR": # called as module
    ...
    from DeepSR import epoch_sleep
...
class DeepSR(object):
    ...
    def prepare_callbacks(self):
        ...
        # Sleep after an epoch is finished. Aim of this is to
        # protect GPUs from over heating.
        if hasattr(self, "esleep") and self.esleep > 0:
            callbacks.append(epoch_sleep.EpochSleep(self.esleep))
