...
def get_report_object_key_path(url: str, scan_name: str, tool_name: str, date_string: str = None, time_string: str = None,
    ...
    """
    if not date_string:
        date_string = time_utils.get_year_month_day_string()
    if not time_string:
    ...
    if o.path:
        url_path = o.path
        # if it is literally /, set it to root
        if url_path == "/":
            url_path = "root"
