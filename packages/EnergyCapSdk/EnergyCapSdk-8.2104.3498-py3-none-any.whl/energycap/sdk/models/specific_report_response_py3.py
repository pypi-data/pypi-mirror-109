...
class SpecificReportResponse(Model):
    ...
    def __init__(self, *, specific_report_id: int=None, base_report=None, specific_report_code: str=None, specific_report_info: str=None, last_viewed=None, recommended: bool=None, report_category=None, description: str=None, visible: bool=None, shared: bool=None, user=None, subscription=None, **kwargs) -> None:
