...
class LicenseFeatures(Model):
    ...
    def __init__(self, *, accounting_export: bool=None, bill_accruals: bool=None, chargebacks: bool=None, cost_avoidance: bool=None, custom_benchmarks: bool=None, interval_data_analysis: bool=None, report_designer: bool=None, **kwargs) -> None:
