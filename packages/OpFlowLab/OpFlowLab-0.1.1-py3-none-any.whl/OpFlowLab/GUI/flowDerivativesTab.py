...
class flowDerivativesTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.derivativeList = {"Vorticity": np.array([[-1, 0], [0, 1]]),
                               "Divergence": np.array([[0, 1], [1, 0]]),
                               "Simple Shear": np.array([[1, 0], [0, 1]])}
        ...
        self.processButton = QPushButton("Process FlowDerivative")
        self.processButton.setEnabled(False)
        self.buttons = QHBoxLayout()
        self.buttons.addWidget(self.processButton)
        self.displayOutput = QPushButton("Display FlowDerivative")
    ...
    def updateToProcessButton(self):
        ...
        self.processButton.setText("Process FlowDerivative")
        self.thread.quit()
