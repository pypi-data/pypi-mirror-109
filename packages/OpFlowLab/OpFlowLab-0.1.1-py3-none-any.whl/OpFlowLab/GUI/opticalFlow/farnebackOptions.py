...
class farnebackOptions(QWidget):
    def __init__(self):
        ...
        self.windowSizeLineEdit = QLineEdit("13")
        ...
        self.iterationsLineEdit = QLineEdit("10")
        ...
        self.sigmaLineEdit = QLineEdit("1.1")
    ...
    def getParameters(self):
        ...
        sigma = self.prepParameters(self.sigmaLineEdit.text(), float)
