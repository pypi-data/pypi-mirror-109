...
class DApi2(object):
    ...
    def __init__(self, comm, regsfile=None, dev_mode=False, errorsfie=None):
        '''Constructor'''
        ...
        if errorsfie is None:
            errorsfie = os.path.join(os.path.dirname(__file__), 'errors.xml')        
        self.derrors = DErrorsContainer(self, errorsfie) 
