...
instrument_id = 'j9999'
begin_trading_date = datetime.datetime(2016, 1, 4)
end_trading_date = datetime.datetime(2016, 1, 4)
interval = 120
...
time_frame = BaseBarHelper.create_data_frame_in_day_date_time_slice_by_date_consider_holiday(
    qi_data_controller.instrument_manager, instrument_id, begin_trading_date, end_trading_date, interval, bar_type
)
print('time_frame')
print(time_frame)
