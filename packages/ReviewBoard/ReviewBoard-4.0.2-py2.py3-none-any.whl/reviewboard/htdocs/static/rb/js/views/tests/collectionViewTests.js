...
suite('rb/views/CollectionView', function () {
    ...
    describe('Rendering', function () {
        ...
        it('With items', function () {
            collection.add([{ data: 'Item 1' }, { data: 'Item 2' }]);
    ...
    describe('Live updating', function () {
        it('Adding items after rendering', function () {
            ...
            collection.add([{ data: 'Item 2' }, { data: 'Item 3' }]);
        ...
        it('Removing items after rendering', function () {
            ...
            var model2 = new TestModel({ data: 'Item 2' });
            var model3 = new TestModel({ data: 'Item 3' });
        ...
        it('Changing sort order', function () {
            collection.add([{ data: 'Item 2' }, { data: 'Item 3' }, { data: 'Item 1' }]);
        ...
        it('When reset', function () {
            ...
            collection.reset([{ data: 'Item 3' }, { data: 'Item 4' }, { data: 'Item 5' }]);
