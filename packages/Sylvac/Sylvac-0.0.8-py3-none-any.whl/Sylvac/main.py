                    ...
                    if self.Serial.in_waiting > 0 and self.Serial.isOpen():
                        ...
                        if num == 0:
                            ...
                            if SolanDoThuoc2 >= 1:
                                ...
                                if 0 not in self.DataReader['Thuoc2'][0]:
                            ...
                            if SolanDoThuoc == 3:
                                ...
                                if 0 not in self.DataReader['Thuoc1']:  # (self.DataReader['Thuoc1'] != None and self.DataReader['Thuoc2'] != None)
                                    ...
                                    val = (id, str(Ngay), Times, iDNgay, self.DataReader['Thuoc1'][0],
                                           self.DataReader['Thuoc1'][1], self.DataReader['Thuoc1'][2], 0, 0, 0, '')
                                    ...
                                    SolanDoThuoc = 0
                                    UpdateDict(up, self.DataReader)
                                    self.Gui.lbsoluong.setText(
                                        '<p align="center"><span style=" color:#0000ff;">' + str(iDNgay) + '</span></p>')
