...
class RadioPanel(QtWidgets.QGroupBox, Ui_RadioPanel):
    ...
    def setup_callbacks(self):
        ...
        self.update_device_list_timer.start(1000)
    ...
    def setup_proxy_operations(self):
        ...
        self.stop_radio_manager_op_no_cb = hyperborea.proxy.DeviceOperation(
            stop_radio_manager)
...
#             self.start_proxy_operation(self.stop_radio_manager_op_no_cb)
#             self.stopped.set()
#
