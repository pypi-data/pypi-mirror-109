...
default_datetime_format_json = '%Y-%m-%dT%H:%M:%S%z'
...
class KafkaHandler(logging.Handler):
    ...
    def __init__(self, app: str, topic: str, kafka_producer: {}, kafka_producer_sender: {} = {},
                 json_dump: {} = None, use_queue=True, level=logging.NOTSET):
    ...
    def handle(self, record: logging.LogRecord):
        ...
        km.msg = record.msg
        km.at = datetime_fn(datetime.fromtimestamp(record.created, tz=get_sys_timezone()))
