...
from aheadworks_bitbucket_manager.api.jira_api_manager import JiraApiManager
...
from aheadworks_bitbucket_manager.model.data.jira import JiraConfig
...
class Console:
    ...
    def __init__(self):
        ...
        self.jira_api_manager = JiraApiManager(jira_config)
