...
run "python3 -m animality help" to see the usage.
...
""")
  ...
  fetching data from the API:
    python3 -m animality [animal]
    python3 -m animality [animal1] [animal2] [animal3] ...
    python3 -m animality random

  others:
    python3 -m animality help
    python3 -m animality about
