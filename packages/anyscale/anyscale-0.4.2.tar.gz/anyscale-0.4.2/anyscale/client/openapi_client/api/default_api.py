...
class DefaultApi(object):
    ...
    def get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post(self, session_id, url, ready, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post(session_id, url, ready, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str session_id: (required)
        :param str url: (required)
        :param bool ready: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post_with_http_info(session_id, url, ready, **kwargs)  # noqa: E501

    def get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post_with_http_info(self, session_id, url, ready, **kwargs):  # noqa: E501
        """Get Or Create Cluster Monitor  # noqa: E501

        Get or create a cluster monitor object for the session.  Returns the URL of the cluster monitor and its status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post_with_http_info(session_id, url, ready, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('url' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `url` when calling `get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post`")  # noqa: E501
        # verify the required parameter 'ready' is set
        if self.api_client.client_side_validation and ('ready' not in local_var_params or  # noqa: E501
                                                        local_var_params['ready'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ready` when calling `get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post`")  # noqa: E501
