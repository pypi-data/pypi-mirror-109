...
class ComputeTemplateQuery(object):
    ...
    def __init__(self, orgwide=False, project_id=None, name=None, include_anonymous=False, local_vars_configuration=None):  # noqa: E501
    ...
    def name(self):
        ...
        Filters ComputeTemplates by name. If this field is absent, no filtering is done. For now, only equals match is supported.  # noqa: E501
