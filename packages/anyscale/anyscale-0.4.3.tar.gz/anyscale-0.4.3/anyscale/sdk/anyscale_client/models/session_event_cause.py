...
class SessionEventCause(object):
    ...
    def cause_user(self, cause_user):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and cause_user is None:  # noqa: E501
            raise ValueError("Invalid value for `cause_user`, must not be `None`")  # noqa: E501
    ...
    def cause_system(self, cause_system):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and cause_system is None:  # noqa: E501
            raise ValueError("Invalid value for `cause_system`, must not be `None`")  # noqa: E501
