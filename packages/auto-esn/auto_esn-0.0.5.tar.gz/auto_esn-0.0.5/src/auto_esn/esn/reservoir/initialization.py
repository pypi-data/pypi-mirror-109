...
from src.auto_esn.esn.reservoir.util import get_regular_graph_mask, get_star_graph_mask, set_all_seeds



# todo clean?
from src.auto_esn.utils.math import spectral_normalize
from src.auto_esn.utils.types import Initializer
