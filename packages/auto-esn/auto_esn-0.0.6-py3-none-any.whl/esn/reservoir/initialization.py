...
from auto_esn.esn.reservoir import get_regular_graph_mask, get_star_graph_mask, set_all_seeds



# todo clean?
from auto_esn.utils import spectral_normalize
from auto_esn.utils import Initializer
