...
setup(
    ...
    description='A set of wrapper libraries and command line tools for interacting with Cisco\'s CML or VIRL2 application',  # Optional
    ...
    #
    packages=['autocml'], # find_packages('src'),  # Required
    ...
    install_requires=['pyyaml', 'netmiko', 'ntc_templates', 'virl2_client'],  # Optional
    ...
    #     'console_scripts': [
	# 		'cml-assert-ints=autocml.scripts.assert_ints:main',
	# 		'cml-bulk-yaml=autocml.scripts.bulk_yaml:main',
	# 		'cml-dump-ints=autocml.scripts.dump_ints:main',
	# 		'cml-dump-pings=autocml.scripts.dump_pings:main',
	# 		'cml-dump-cfgs=autocml.scripts.dump_cfg:main',
	# 		'cml-pcap=autocml.scripts.pcap:main',
    #     ],
    # },
