        ...
        if grouped == "date-member":
            for date in list(dates.keys()):
                for member in self._member_list:
                    ...
                    list_groups[group_name] = {"color": final_color}
            ...
            for group in list_groups.keys():
                ...
                x_coordinate = random.choice(x_bound)
                y_coordinate = random.choice(y_bound)
