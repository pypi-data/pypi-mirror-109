...
class CfnEnvironment(
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrCloudWatchLogGroupArn")
    def attr_cloud_watch_log_group_arn(self) -> builtins.str:
        '''
        :cloudformationAttribute: CloudWatchLogGroupArn
        '''
        return typing.cast(builtins.str, jsii.get(self, "attrCloudWatchLogGroupArn"))
