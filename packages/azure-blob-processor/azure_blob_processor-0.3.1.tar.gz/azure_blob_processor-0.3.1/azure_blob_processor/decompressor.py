...
class Decompressor():
    ...
    async def process_blob_file(self, container_name, blob_client, dest_dir, local_file):
        ...
        await self.upload_decompressed_files(container_name, dest_dir, decompression_dir, metadata_json)
    ...
    async def upload_decompressed_files(self, container_name, dest_dir, decompression_dir, metadata_json):
        blob_service_client = BlobServiceClient.from_connection_string(self.conn_str)
        ...
        async with blob_service_client:
            for file in files_to_upload:
                await self.upload_decompressed_file(blob_service_client, file, container_name, dest_dir, metadata_json)      

    async def upload_decompressed_file(self, blob_service_client, file, container_name, dest_dir, metadata_json):
