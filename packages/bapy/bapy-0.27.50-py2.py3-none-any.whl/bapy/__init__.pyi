...
VENV_CLEAR_DEFAULT: Union[_T, bool] = ...
VENV_DEPS_DEFAULT: Union[_T, bool] = ...
...
def fromiter(data: typing.Iterable[Callable], *args: Union[str, nstr, typing.Iterable[str, nstr]]) -> DictStrAny: ...
def funcdispatch(func: Callable):...
def get(data: Any, *args: Any, default: bool = ..., one: bool = ..., recursive: bool = ...,
        with_keys: bool = ...) -> Any:...
...
ClassBase = NamedTuple('ClassBase', annotation=dict[str, DictStrAny], attribute=dict[str, Attribute], cls=Type,
                       ...
                       signature=dict[Type[Any], dict[str, Any]], slot=set[str, ...],)
class Class(ClassBase):
    cache: dict[TypesType, Class] = ...
    __slots__ = ()
    def __new__(cls, data: Union[Is, TypesType]) -> Class: ...
    def __iter__(self) -> Iterator[Str]: ...
    def filter(self, name: Literal['attributes', 'coros', 'defaults', 'hashs', 'inits', 'nodatas', 'pprops', 'reprs',
                                   'slots', 'states'], access: Access = ...) -> Optional[Union[dict, tuple]]: ...
    @classmethod
