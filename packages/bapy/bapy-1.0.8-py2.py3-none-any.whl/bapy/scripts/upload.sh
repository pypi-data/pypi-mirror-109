...
<<<<<<< HEAD
<<<<<<< HEAD
  project_path="${BAPY}"; name="${BASH_RC_NAME}"; twine="${GITHUB_ORGANIZATION_USERNAME}"
#  project_path="${BASH_RC_PROJECT}"; name="${BASH_RC_NAME}"; twine=pypi
=======
  project_path="${BAPY}"; name="${BAPY}"; twine="${GITHUB_ORGANIZATION_USERNAME}"
>>>>>>> recover1002
=======
  project_path="${BAPY}"; name="$( basename "${BAPY}" )"; twine="${GITHUB_ORGANIZATION_USERNAME}"
>>>>>>> recover1002
