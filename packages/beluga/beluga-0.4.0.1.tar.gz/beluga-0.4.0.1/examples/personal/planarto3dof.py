...
ocp_2.terminal_constraint('gam', 'rad', lower='-half_ang', upper='half_ang', activator='eps_ang', method='utm')
ocp_2.terminal_constraint('psi', 'rad', lower='-half_ang', upper='half_ang', activator='eps_ang', method='utm')
...
ocp_2.constant('half_ang', 5*pi/2, 'rad')
ocp_2.constant('eps_ang', 1e-2, '1')
