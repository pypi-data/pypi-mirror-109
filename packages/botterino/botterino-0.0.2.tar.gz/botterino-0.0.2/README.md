...
0. All the files you interact with will live in the botterino-config folder which is located:
    1. windows: `C:\\Documents and Settings\\<your username>\\botterino-config`
...
3. You must [create a Reddit app](https://www.reddit.com/prefs/apps/) see `sample-praw.ini` for an example
...
4. Fill out the rest of 'praw.ini' with your Reddit username/password as well as anything you want for `user_agent`
