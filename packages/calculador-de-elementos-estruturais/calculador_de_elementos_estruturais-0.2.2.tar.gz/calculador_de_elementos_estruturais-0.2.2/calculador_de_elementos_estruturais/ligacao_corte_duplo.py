...
class LigacaoCorteDuplo:
    def __init__(self, enunciado):
        ...
        self.r_ligacao_central = CalculadorLigacao.calcula_r_ligacao(self.quantidade_pinos, self.rvd_1_central)
        self.r_ligacao_lateral = CalculadorLigacao.calcula_r_ligacao(self.quantidade_pinos, self.rvd_1_lateral)
...
{abre_negrito}fc0d lateral{fecha_negrito}: {round(self.fc0d_lateral, 3)} MPa
