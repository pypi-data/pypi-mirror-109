...
DisplayFieldStyleValue = typing___NewType('DisplayFieldStyleValue', builtin___int)
type___DisplayFieldStyleValue = DisplayFieldStyleValue
DisplayFieldStyle: _DisplayFieldStyle
class _DisplayFieldStyle(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[DisplayFieldStyleValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    DISPLAY_FIELD_STYLE_UNSPECIFIED = typing___cast(DisplayFieldStyleValue, 0)
    DISPLAY_FIELD_STYLE_TEXT = typing___cast(DisplayFieldStyleValue, 1)
    DISPLAY_FIELD_STYLE_TEXTAREA = typing___cast(DisplayFieldStyleValue, 2)
    DISPLAY_FIELD_STYLE_CHECKBOX = typing___cast(DisplayFieldStyleValue, 3)
    DISPLAY_FIELD_STYLE_SWITCH = typing___cast(DisplayFieldStyleValue, 4)
DISPLAY_FIELD_STYLE_UNSPECIFIED = typing___cast(DisplayFieldStyleValue, 0)
DISPLAY_FIELD_STYLE_TEXT = typing___cast(DisplayFieldStyleValue, 1)
DISPLAY_FIELD_STYLE_TEXTAREA = typing___cast(DisplayFieldStyleValue, 2)
DISPLAY_FIELD_STYLE_CHECKBOX = typing___cast(DisplayFieldStyleValue, 3)
DISPLAY_FIELD_STYLE_SWITCH = typing___cast(DisplayFieldStyleValue, 4)
type___DisplayFieldStyle = DisplayFieldStyle
...
class DisplayField(google___protobuf___message___Message):
    ...
    field_style: type___DisplayFieldStyleValue = ...
    ...
    def __init__(self,
        *,
        ...
        field_style : typing___Optional[type___DisplayFieldStyleValue] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"display",b"display",u"field_style",b"field_style",u"field_type",b"field_type",u"initial_value",b"initial_value",u"key",b"key",u"options",b"options",u"render_when",b"render_when",u"required",b"required"]) -> None: ...
