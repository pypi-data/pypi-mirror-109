...
class MetricServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMetricValue = channel.unary_unary(
                '/calixa.domain.metric.MetricService/GetMetricValue',
                request_serializer=metric__pb2.MetricValueRequest.SerializeToString,
                response_deserializer=metric__pb2.MetricValue.FromString,
                )
...
def add_MetricServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMetricValue': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=metric__pb2.MetricValueRequest.FromString,
                    response_serializer=metric__pb2.MetricValue.SerializeToString,
            ),
...
class MetricService(object):
    ...
    def GetMetricValue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.metric.MetricService/GetMetricValue',
            metric__pb2.MetricValueRequest.SerializeToString,
            metric__pb2.MetricValue.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
