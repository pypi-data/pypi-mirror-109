...
from certora_cli.certoraUtils import OPTION_OUTPUT_VERIFY, fatal_error, is_windows, remove_and_recreate_dir, getcwd
...
from certora_cli.certoraUtils import get_file_basename, get_file_extension, safe_create_dir, \
    prepare_call_args
from certora_cli.certoraUtils import is_hex, decimal_str_to_cvt_compatible, hex_str_to_cvt_compatible, abs_posix_path
...
class CertoraBuildGenerator:
    ...
    def get_standard_json_data(self, sdc_name: str) -> Dict[str, Any]:
        return read_json_file(f"{self.config_path}/{sdc_name}.standard.json.stdout")
