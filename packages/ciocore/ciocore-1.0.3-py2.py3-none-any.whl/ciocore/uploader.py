...
class MD5Worker(worker.ThreadWorker):
    ...
    def do_work(self, job, thread_int):
        ...
        assert isinstance(filename, (str, unicode)), "Filepath not of expected type. Got %s" % type(
            filename
        )
...
"""
    ...
    def handle_upload_response(self, project, upload_files, upload_id=None, md5_only=False):
        """
        This is a reallly confusing method and should probably be split into to clear logic
