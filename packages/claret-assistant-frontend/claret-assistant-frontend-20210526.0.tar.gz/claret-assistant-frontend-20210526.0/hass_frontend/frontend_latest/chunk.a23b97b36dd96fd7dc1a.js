/*! For license information please see chunk.a23b97b36dd96fd7dc1a.js.LICENSE.txt */
(self.webpackChunkclaret_assistant_frontend=self.webpackChunkclaret_assistant_frontend||[]).push([[5335],{18601:(t,i,e)=>{"use strict";e.d(i,{qN:()=>n.q,Wg:()=>a});var n=e(78220);class a extends n.H{click(){this.formElement&&(this.formElement.focus(),this.formElement.click())}setAriaLabel(t){this.formElement&&this.formElement.setAttribute("aria-label",t)}firstUpdated(){super.firstUpdated(),this.shadowRoot&&this.mdcRoot.addEventListener("change",(t=>{this.dispatchEvent(new Event("change",t))}))}}a.shadowRootOptions={mode:"open",delegatesFocus:!0}},63207:(t,i,e)=>{"use strict";e(65660),e(15112);var n=e(9672),a=e(87156),o=e(50856),s=e(65233);(0,n.k)({_template:o.d`
    <style>
      :host {
        @apply --layout-inline;
