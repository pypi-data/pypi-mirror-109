...
class Table(Component):
    ...
    def __init__(self, csv_str=None, index=None, format="github", sep=",*", **kwargs):
        super().__init__(**kwargs)
        self.index = index
        self.kwargs = kwargs
        self.format = format
    ...
    def _md(self):
        ...
        if not self.children:
            return self.data.to_markdown(index=self.index,
    ...
    @property
    def _html(self):
        return self.data.to_html(index=self.index, **self.kwargs)
