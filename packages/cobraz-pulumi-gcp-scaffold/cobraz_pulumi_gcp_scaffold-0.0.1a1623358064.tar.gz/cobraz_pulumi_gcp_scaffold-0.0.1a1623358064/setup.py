...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp-scaffold', '0.0.1-alpha.1623358064+0d9c88ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp-scaffold 0.0.1-alpha.1623358064+0d9c88ff`
                """)
            else:
                raise
