...
class PyGridHandler:
    ...
    def grid_box_rectangle(self, width, height, grid:RectGrid, margin: int = 1) -> Rectangle:
    ...
    def _draw_grid_boxes(self, surface:pygame.Surface, grid: RectGrid, margin=1, grid_color: Color = None, draw_scale_matrix = None):
    ...
    def _draw_grid_lines(self, surface:pygame.Surface, grid: RectGrid, margin=1, grid_color: Color = None, draw_scale_matrix = None):
        grid_box_rect = self.grid_box_rectangle(surface.get_width(), surface.get_height(), grid, margin)
