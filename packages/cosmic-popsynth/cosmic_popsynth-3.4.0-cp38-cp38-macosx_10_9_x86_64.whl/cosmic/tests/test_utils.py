...
class TestUtils(unittest.TestCase):
    ...
    def test_conv_select(self):
        ...
        conv, bin_nums = utils.conv_select(BCM_TEST, BPP_TEST, [13,14], list(range(0,15)), conv_dict_1_SN['pop_select'], {})
        self.assertEqual(len(conv), 0)

        conv, bin_nums = utils.conv_select(BCM_TEST, BPP_TEST, [13,14], list(range(0,15)), conv_dict_2_SN['pop_select'], {})
        self.assertEqual(len(conv), 0)

        conv, bin_nums = utils.conv_select(BCM_TEST, BPP_TEST, [13,14], list(range(0,15)), conv_dict_disruption['pop_select'], {})
        ...
        conv, bin_nums = utils.conv_select(BCM_TEST, BPP_TEST, [13,14], list(range(0,15)), conv_dict_XRB_form['pop_select'], {})
        self.assertEqual(len(conv), 0)
