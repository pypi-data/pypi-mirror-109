...
class ImgSelect(ttk.LabelFrame):
    ...
    def init_components(self):
        # Labels
        # self.indication_labels = [
        #     ttk.Label(self, text=label) for label in ["Primary", "Secondary"]
        # ]

        # Variables

        # [
        #     var.trace("w", lambda *args, i=i: self.new_selection(i))
    ...
    def place_components(self):
        ...
        #     for i, label in enumerate(self.indication_labels)
        # ]
        [
