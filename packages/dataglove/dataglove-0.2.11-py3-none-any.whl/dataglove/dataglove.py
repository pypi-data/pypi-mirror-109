...
def Forte_SelectHapticWave(dataGloveIO, actuatorID, waveform, soundChannel):
	__connectionException(dataGloveIO)
...
def Forte_SetGrainLocation(dataGloveIO, actuatorID, location, soundChannel):
	__connectionException(dataGloveIO)
