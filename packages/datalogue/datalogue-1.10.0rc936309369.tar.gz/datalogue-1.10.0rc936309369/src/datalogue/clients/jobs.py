...
class _JobsClient:
    ...
    def list(
        self, 
        statuses: List['JobStatus'] = [JobStatus.Scheduled, JobStatus.Defined, JobStatus.Running, JobStatus.Succeeded, JobStatus.Failed, JobStatus.Unknown, JobStatus.Cancelled], 
        ...
        params = {
            "job-statuses" : statuses_list,
            "job-type-filter" : job_type_list
        }
        ...
        res = self.http_client.make_authed_request(path=self.service_uri + endpoint, method=HttpMethod.GET, params=params)
