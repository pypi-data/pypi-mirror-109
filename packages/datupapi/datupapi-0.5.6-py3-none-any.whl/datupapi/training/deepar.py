...
class DeepAR(Config):
    ...
    def create_predictor_deepar(self, predictor_name, dataset_group_arn, use_location=False, use_automl=False):
        """
        ...
        :param use_location: True or false to use location column in the dataset. Default False.
        :param use_automl: True or False to perform AutoML among univariate and multivariate models. Default False.
        :return response: API's response
