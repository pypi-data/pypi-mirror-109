...
class Lattice:
    ...
    def combine(self, fs):
        ...
        if not isinstance(fs, (FocalSet)):
            ...
            fs1, bpa1 = self._fs.fod.as_arrays()
            ...
            self.__combine1[blockspergrid, threadsperblock](d_fs1, d_fs2, d_bpa1, d_bpa2, d_fs_out, d_bpa_out, d_bpa_final)
            ...
            comb_fs = FocalSet(self._fod, bpa_final, fs_out)
