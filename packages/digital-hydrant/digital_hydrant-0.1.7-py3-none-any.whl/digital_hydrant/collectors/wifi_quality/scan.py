# TODO: When we have more time, we should fix this up
# Copied from: https://github.com/rockymeza/wifi/blob/master/wifi/scan.py
#
# This package is not available as a ubuntu package, and is no longer actively maintained.
# We only need the scanning code, which I copied here.
...
quality_re_dict = {
    ...
    "absolute": re.compile(
        r"Quality[=:](?P<quality>\d+).*Signal level[=:](?P<siglevel>\d+)"
    ),
}
