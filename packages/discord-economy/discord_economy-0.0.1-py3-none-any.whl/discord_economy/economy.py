...
class Client:
    def __init__(self, *, db='discord_economy',db_cluster='Economy', mongo_datebase='localhost:27017', guild_only=False):
        self._name = db_cluster
        self._db = db
        self._guild_only = guild_only
        self._mongo_connection = pymongo.MongoClient(mongo_datebase)
        if self._guild_only == True:
            print("Guild_only maybe coming soon | discord_economy.__support__ ")
