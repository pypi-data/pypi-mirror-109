...
setup(
    name='dislash.py',
    version=version,
    description='A python wrapper for discord slash commands and message components.',
    ...
    keywords='python, discord, slash, commands, api, discord-api, discord-py, slash-commands, buttons, components, message-components',
