...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        """
        stdev = math.sqrt(self.p * self.n * (1 - self.p) )
        self.stdev = stdev
        return self.stdev
    ...
    def plot_bar(self):
        ...
        Returns:
            None
        """
        plt.bar(x=['1','0'], height = [self.p*self.n , (1 - self.p) * self.n])
        plt.title('Binomial Distribution')
        plt.xlabel('Head = 1 or Tail = 0')
        plt.ylabel('Times')
    ...
    def plot_bar_pdf(self):
        ...
        plt.bar( x , height = y)
        plt.title('Probablity of Outcome')
        plt.xlabel('Outcome')
