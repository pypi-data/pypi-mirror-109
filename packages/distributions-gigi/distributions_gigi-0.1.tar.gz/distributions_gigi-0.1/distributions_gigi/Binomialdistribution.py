...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        self.p = prob
        self.n = size
        # Inherit calculate_mean and calculate_stdev from Distribution: Instantiate
    ...
    def replace_stats_with_data(self):
        ...
        self.p = sum(self.data)/len(self.data) # sum of ones (head) and zeros (tail)
    ...
    def plot_bar(self):
        ...
        pass        
        plt.hist(self.data, bins=2, range=(0,1), align='mid')
        plt.xlabel('x')
        plt.ylabel('y')
        plt.title('histogram')
    ...
    def __add__(self, other):
        ...
        # no you don't use this line:
        #__init__(other, prob=.5, size=20):
        # Instead: you just use the class directly:
        result = Binomial() # defining a binomial sum of (self + other)
        result.n = self.n + other.n # other is a binomial that already exists
        result.p = self.p
    ...
    def __repr__(self):
        ...
        forrmat(self.mean, self.stdev,self.f, self.n)
