...
def test_translate_spec214_to_214_l0_return_HDU(valid_spec_214_header):
    """
    Validates and tries to translate a fits header against the SPEC-0214 schema
    Given: A valid SPEC-0214 fits header
    When: Validating headers
    ...
    # raises exception on failure
    spec214_validator.validate_and_translate_to_214_l0(
        valid_spec_214_header, return_type=fits.PrimaryHDU
    )


def test_translate_spec214_to_214_return_HDU(valid_spec_214_header):
    """
    Validates and tries to translate a fits header against the SPEC-0214 schema
    Given: A valid SPEC-0214 fits header
    When: Validating headers
