...
def viz(root_obj, compress_level:int = 2, property:str = 'long') -> Tree:
    '''
    :param root_obj: python object
    :param compress_level: 0(No compression) ~ 3(Full compression). each number has its preset printing options. see also compress(Options())
