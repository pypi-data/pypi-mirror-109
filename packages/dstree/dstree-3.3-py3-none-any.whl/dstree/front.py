from .backend import generate_tree, fold_tree, get_example_data, Options, default_options, to_graphviz, fold_and_out, fold, Tree

def viz(root_obj, compress_level:int = 2, property:str = 'long') -> Tree:
    '''
