    ...
    with sentry_sdk.start_span(op="header_authentication", description="Header Authentication") as span:
        ...
        if x_secret_token and x_access_token:
            ...
            if not is_m2m_speedy or not my_auth.active_participant_uuid:
                ...
                ehelply_cloud_entity = asyncio.create_task(
                    access.sdk.get_entity_for_key(key_uuid=key.uuid, partition="ehelply-cloud"))
                ehelply_resources_entity = asyncio.create_task(
                    access.sdk.get_entity_for_key(key_uuid=key.uuid, partition="ehelply-resources"))
        ...
        sentry_sdk.set_user(
            {
                "id": my_auth.active_participant_uuid,
                "project_uuid": my_auth.project_uuid,
                "participant_uuid": my_auth.active_participant_uuid
            }
        )
