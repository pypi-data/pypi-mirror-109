...
class ConfigManager(object):
    ...
    def boot(self):
        ...
        paths.insert(0,"{}/harvester.ini".format(os.path.dirname(sys.modules['__main__'].__file__)))
        if self._config_path: paths.insert(0,self._config_path)
        if os.getenv("EJERICO_CONFIG_PATH") is not None: paths.insert(0,os.getenv("EJERICO_CONFIG_PATH"))
...
def _defaultConfigPaths():
    ...
    paths.append(pkg_resources.resource_filename(__name__, "ejerico-harvester.ini"))
