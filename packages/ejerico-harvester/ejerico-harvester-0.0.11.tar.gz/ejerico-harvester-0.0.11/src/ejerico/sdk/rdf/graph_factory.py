...
class GraphFactory(object):
    ...
    def createGraph():
        ...
        try:
            uri_identifier = URIRef(config.get("domain", default="http://www.ejerico.org"))
            ...
            if "SPARQLUpdateStore" == store:
                ...
                if endpoint_query is None or endpoint_update is None:
                    logging.error("[GraphFactory::createGraph] missing SPARQL query or update entrypoint ({}, {})".format(endpoint_query, endpoint_update))
                    raise SystemExit
