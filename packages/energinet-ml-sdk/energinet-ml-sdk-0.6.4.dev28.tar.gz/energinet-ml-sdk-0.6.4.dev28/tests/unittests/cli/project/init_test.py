...
from energinetml.cli.project.init import (
    init_project,
    _parse_input_path,
    _parse_input_project_name,
    _parse_input_subscription_id,
    _parse_input_resource_group,
    _parse_input_workspace_name,
)
...
@patch('energinetml.cli.project.init.Project.create')
def test__init_project(project_create_mock, backend_mock):
    """
    ...
    backend_mock.get_workspace.return_value = Mock(tags={
        'vnet_name': VNET,
        'subnet_name': SUBNET,
    })
...
def test__parse_input_path__project_files_already_exists_in_folder__should_prompt_to_override(  # noqa: E501
    ...
    with tempfile.TemporaryDirectory() as path:
        ...
        # Act
        with pytest.raises(click.Abort):
            _parse_input_path(ctx=None, param=None, value=path)
...
def test__parse_input_project_name__value_is_none__should_prompt_for_name(prompt_mock):  # noqa: E501
    ...
    # Act
    value = _parse_input_project_name(ctx=Mock(params=params), param=None, value=None)  # noqa: E501
...
def test__parse_input_project_name__value_is_provided__should_return_value(prompt_mock):  # noqa: E501
    ...
    # Act
    value = _parse_input_project_name(ctx=None, param=None, value=NAME)
...
def test__parse_input_subscription_id__value_not_known_subscription__should_prompt_for_subscription_name(  # noqa: E501
    ...
    # Act
    value = _parse_input_subscription_id(ctx=None, param=None, value='foobar')
...
def test__parse_input_resource_group__no_subscription_id_available__should_raise_runtime_error():  # noqa: E501
    ctx = Mock(params={})

    with pytest.raises(RuntimeError):
        _parse_input_resource_group(ctx=ctx, param=None, value=None)
...
def test__parse_input_resource_group__value_not_known_resource_group__should_prompt_for_resource_group(  # noqa: E501
    ...
    # Act
    value = _parse_input_resource_group(ctx=ctx, param=None, value='foobar')
...
def test__parse_input_workspace_name__no_subscription_id_available__should_raise_runtime_error():  # noqa: E501
    ...
    with pytest.raises(RuntimeError):
        _parse_input_workspace_name(ctx=ctx, param=None, value=None)
...
def test__parse_input_workspace_name__no_workspaces_exists_in_resource_group__should_prompt_for_workspace(  # noqa: E501
    ...
    # Act
    value = _parse_input_workspace_name(ctx=ctx, param=None, value=None)
