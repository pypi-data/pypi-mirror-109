...
class TestProject:
    ...
    def test__requirements_file_path(self, project):
        ...
        :param Project project:
        """
        assert project.requirements_file_path == \
               os.path.join(project.path, 'requirements.txt')
    ...
    def test__default_model_path(self, project):
        ...
        assert project.default_model_path(model_name) == \
               os.path.join(project.path, model_name)
    ...
    def test__create__should_create_project_files(self):
        with tempfile.TemporaryDirectory() as path:
            ...
            assert project.requirements.get(PACKAGE_NAME).specs == [('==', str(PACKAGE_VERSION))]  # noqa: E501
