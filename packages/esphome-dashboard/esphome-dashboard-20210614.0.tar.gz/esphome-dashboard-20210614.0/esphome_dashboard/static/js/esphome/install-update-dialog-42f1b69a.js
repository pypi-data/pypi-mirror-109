...
`;let M=class extends _{constructor(){super(...arguments),this._writeProgress=0,this._state="pick_option"}render(){let t,e,i=!1;if("pick_option"===this._state){t="Pick Install Target";const i=u&&y;e=v`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
  ...
  `,t([m()],M.prototype,"filename",void 0),t([m()],M.prototype,"_ports",void 0),t([m()],M.prototype,"_writeProgress",void 0),t([m()],M.prototype,"_configuration",void 0),t([m()],M.prototype,"_state",void 0),t([m()],M.prototype,"_error",void 0),M=t([g("esphome-install-dialog")],M);
