...
class ErpServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.read_products_free_qty = channel.stream_stream(
        '/erp_service.ErpService/read_products_free_qty',
    ...
    self.create_sale_orders = channel.stream_stream(
        '/erp_service.ErpService/create_sale_orders',
    ...
    self.update_sale_orders_infos = channel.stream_stream(
        '/erp_service.ErpService/update_sale_orders_infos',
    ...
    self.done_sale_orders = channel.stream_stream(
        '/erp_service.ErpService/done_sale_orders',
    ...
    self.cancel_sale_orders = channel.stream_stream(
        '/erp_service.ErpService/cancel_sale_orders',
        request_serializer=f99__erp__api__pb2.CancelSaleOrdersParams.SerializeToString,
        response_deserializer=f99__erp__api__pb2.CancelSaleOrderResult.FromString,
        )
    self.reship_sale_orders = channel.stream_stream(
        '/erp_service.ErpService/reship_sale_orders',
        request_serializer=f99__erp__api__pb2.ReshipSaleOrdersParams.SerializeToString,
        response_deserializer=f99__erp__api__pb2.ReshipSaleOrdersResult.FromString,
        )
...
def add_ErpServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'cancel_sale_orders': grpc.stream_stream_rpc_method_handler(
          ...
          request_deserializer=f99__erp__api__pb2.CancelSaleOrdersParams.FromString,
      ...
      'reship_sale_orders': grpc.stream_stream_rpc_method_handler(
          ...
          request_deserializer=f99__erp__api__pb2.ReshipSaleOrdersParams.FromString,
          response_serializer=f99__erp__api__pb2.ReshipSaleOrdersResult.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'erp_service.ErpService', rpc_method_handlers)
