...
_PROTOSETUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outputFilePrefix', full_name='communication.ProtoSetup.outputFilePrefix', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outputFileTimeStamp', full_name='communication.ProtoSetup.outputFileTimeStamp', index=5,
