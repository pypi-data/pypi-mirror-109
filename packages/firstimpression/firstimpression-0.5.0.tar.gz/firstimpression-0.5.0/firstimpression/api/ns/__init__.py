...
from firstimpression.api import request, request_json
from firstimpression.time import parse_string_to_date, parse_string_time_to_minutes
...
def get_parsed_departures(response_json):
