...
def get_parsed_departures(response_json, date_format, time_format):
    ...
    for departure in departures:
        ...
        parsed_departure['departure_time'] = parse_date_to_string(
            parse_string_to_date(get_departure_time(departure), date_format), time_format)
