                    ...
                    if i != self:
                        ...
                        if i.transform.position.x - (i.size.x / 2) <= paren.transform.position.x + (paren.size.x / 2) <= i.transform.position.x + (i.size.x / 2):
                            if i.transform.position.y + (i.size.y / 2) >= paren.transform.position.y - (paren.size.y / 2) >= i.transform.position.y - (i.size.y / 2):
                                ...
                                crash = True
                        elif i.transform.position.x + (i.size.x / 2) >= paren.position.x - (paren.size.x / 2) >= i.transform.position.x - (i.size.x / 2):
                            if i.transform.position.y + (i.size.y / 2) >= paren.position.y - (paren.size.y / 2) >= i.transform.position.y - (i.size.y / 2):
                                crash = True
                            elif i.transform.position.y - (i.size.y / 2) <= paren.transform.position.y + (paren.y / 2) <= i.transform.position.y + (i.size.y / 2):
                                crash = True
                        if crash is True:
