...
class get_Reward(object):
    ...
    def __init__(self, batch_num, maxlen, dim, inputdata, sl, su, lambda1_upper, 
        ...
        #self.bic_penalty_GPR = np.log(inputdata.shape[0]/2)/(inputdata.shape[0]/2)
    ...
    def calcualte_QR(self, X_train, y_train):
    ...
    def calculate_reward_single_graph(self, graph_batch, lambda1, lambda2):
        ...
        for i in range(self.maxlen):
            ...
            if np.sum(col) < 0.1:
                ...
                y_err = self.calculate(X_train, y_train, ones)
