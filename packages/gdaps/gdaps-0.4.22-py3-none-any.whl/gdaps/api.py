...
class InterfaceMeta(type):
    ...
    def all_plugins(cls) -> typing.Iterable:
        ...
        logger.warning(f"<Interface>.plugins() is deprecated. You cna iteate directly over {mcs.__name}.")
        return cls._implementations

    def plugins(mcs) -> typing.Iterable:
        """Returns all plugins, even if they are not enabled."""
        logger.warning(f"<Interface>.plugins() is deprecated and will be removed. Please iterate directly over the {mcs.__name__} class.")
        return mcs.__iter__()
