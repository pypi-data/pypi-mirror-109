...
class GRENMLManager:
    ...
    The manager will default to a deterministic id generation scheme.
    """

    def __init__(self, name=None, validator=TopologyValidator(), writer=GRENMLWriter,
                 id_format: meta.IDGeneration = None, *args, **kwargs):
        self._topology = Topology(name=name, *args, **kwargs)
        self._writer = writer(self)
        self._validator = validator
        self._validator.topology = self._topology
        self._id_format = id_format if id_format else meta.IDGeneration.DETERMINATE
    ...
    def add_institution(
        ...
        if id and isinstance(id, meta.GRENMLObject):
            ...
            inst = Institution(
                ...
                id_format=self._id_format, **kwargs
            )
    ...
    def add_node(
            ...
            version=None, id_format: meta.IDGeneration = None, **kwargs
    ):
        if id and isinstance(id, meta.GRENMLObject):
            node = id
        else:
    ...
    def add_link(
            ...
            lifetime_start=None, lifetime_end=None, version=None,
            id_format: meta.IDGeneration = None, **kwargs
    ):
