...
def culc_frequency(x, y, values="max"):
    """ culculate frequency of y.
    :param values: max or min"""
...
def culc_fig_fre(mat,
    ...
    if method == "1d":
        ...
        if show_fig:
            ...
            plt.show()
        frequncy = culc_frequency(x[30:-30], y_rebuild[30:-30],
                                  values=values)[0]
