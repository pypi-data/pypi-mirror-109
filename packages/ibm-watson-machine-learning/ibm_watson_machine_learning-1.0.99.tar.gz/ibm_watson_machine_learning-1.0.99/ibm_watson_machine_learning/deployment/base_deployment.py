...
class BaseDeployment(ABC):
    ...
    def _publish_model(self,
        ...
        # TODO: Remove `if ICP_40` when promotion will be available for cloud
        # Note: publish model to project and then promote to space
        if self._source_workspace.wml_client.ICP_40 and self._source_workspace.project_id and self._source_workspace.project_id in str(meta_props):
