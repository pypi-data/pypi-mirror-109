...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rdc', '0.0.1-alpha.1623692376+59d43dbb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rdc 0.0.1-alpha.1623692376+59d43dbb`
                """)
            else:
                raise
