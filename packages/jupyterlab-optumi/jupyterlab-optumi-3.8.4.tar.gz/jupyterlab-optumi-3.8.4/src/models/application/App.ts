...
export class App {
	...
	public static reconstruct(appMap: any): App {
		...
		for (let module of appMap.modules) {
			...
			var mod: Module = new Module(module.uuid, module.machine ? Object.setPrototypeOf(module.machine, Machine.prototype) : null, module.token, output, updates, files, monitoring, lastPatch);
