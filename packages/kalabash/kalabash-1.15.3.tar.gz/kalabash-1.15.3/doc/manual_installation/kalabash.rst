...
.. sourcecode:: bash
  ...
  > mysqladmin -u root -p create kalabash

Deploy an instance
------------------

``kalabash-admin.py``, a command line tool, lets you deploy a
*ready-to-use* Kalabash site using only one instruction::
