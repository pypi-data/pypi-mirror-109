...
class KaldelaTestCase(ParametersMixin, TestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KaldelaTestCase, cls).setUpTestData()
...
class KaldelaAPITestCase(ParametersMixin, APITestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KaldelaAPITestCase, cls).setUpTestData()
        management.call_command("load_initial_data")
    ...
    def setUp(self):
        """Setup."""
        super(KaldelaAPITestCase, self).setUp()
