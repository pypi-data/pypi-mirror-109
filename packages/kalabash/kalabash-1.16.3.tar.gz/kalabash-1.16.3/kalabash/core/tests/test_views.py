...
class LoginTestCase(KaldelaTestCase):
...
class DashboardTestCase(KaldelaTestCase):
    """Dashboard tests."""
...
class SettingsTestCase(KaldelaTestCase):
    """Settings tests."""
...
class PreferencesTestCase(KaldelaTestCase):
