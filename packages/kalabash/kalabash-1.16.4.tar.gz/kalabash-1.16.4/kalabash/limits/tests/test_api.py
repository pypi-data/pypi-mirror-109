...
class APIAdminLimitsTestCase(lib_tests.KaldelaAPITestCase):
...
class APIDomainLimitsTestCase(lib_tests.KaldelaAPITestCase):
    """Check that limits are used also by the API."""
...
class ResourcesAPITestCase(lib_tests.KaldelaAPITestCase):
    """Check resources API."""
