...
from kalabash.lib.tests import KaldelaAPITestCase
from . import utils
from .. import factories, models


class DomainAPITestCase(KaldelaAPITestCase):
    """Check API."""
...
class DomainAliasAPITestCase(KaldelaAPITestCase):
...
class AccountAPITestCase(KaldelaAPITestCase):
    """Check Account API."""
...
class AliasAPITestCase(KaldelaAPITestCase):
    """Check Alias API."""
...
class SenderAddressAPITestCase(KaldelaAPITestCase):
