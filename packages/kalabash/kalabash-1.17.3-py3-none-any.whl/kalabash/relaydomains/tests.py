...
from kalabash.lib.tests import KaldelaAPITestCase, KaldelaTestCase
...
class RelayDomainsTestCase(KaldelaTestCase, Operations):
...
class ImportTestCase(KaldelaTestCase):
    """Test import."""
...
class LimitsTestCase(KaldelaTestCase, Operations):
...
class RelayDomainAPITestCase(DataMixin, KaldelaAPITestCase):
    """API test cases."""
