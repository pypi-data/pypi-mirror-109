...
A working copy of this trigger is available on `Github <https://raw.githubusercontent.com/kalabash/kalabash-installer/master/kalabash_installer/scripts/files/dovecot/install_kalabash_postgres_trigger.sql>`_.
