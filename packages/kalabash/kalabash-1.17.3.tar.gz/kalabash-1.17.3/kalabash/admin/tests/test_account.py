...
from kalabash.lib.tests import NO_LDAP, KaldelaTestCase
...
class AccountTestCase(KaldelaTestCase):
...
class LDAPAccountTestCase(test_ldap.LDAPTestCaseMixin, KaldelaTestCase):
...
class PermissionsTestCase(KaldelaTestCase):
