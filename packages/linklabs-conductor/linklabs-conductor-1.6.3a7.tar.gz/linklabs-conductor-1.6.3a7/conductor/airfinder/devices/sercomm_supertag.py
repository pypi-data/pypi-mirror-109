    ...
    def __init__(self):
        ...
        self.msg_types.update({
            ...
            'Configuration': {
                ...
                'def': ['mask', 'lb_mode_sym_heartbeat_interval', 'st_mode_heartbeat_interval',
                        'stationary_lb_location_update_rate', 'moving_lb_location_update_rate',
                        'stationary_st_location_update_rate', 'moving_st_location_update_rate',
...
class SercommSupertag(Supertag):
    ...
    @property
    def moving_lb_location_update_rate(self):
        return self._make_prop(int, "lbModeLocUpdateRate_Moving")

    @property
    def stationary_lb_location_update_rate(self):
