...
from lino.utils import AsynchronousValue
...
class StoreField(object):
    ...
    def __init__(self, field, name, **options):
        ...
        if settings.SITE.default_ui == "lino_react.react":
            if isinstance(field, fields.FakeField) and field.asynchronous:
                self.asynchronous = True
                self.asynchronous = False  # wip
                # print("20210610 asynchronous", name)
