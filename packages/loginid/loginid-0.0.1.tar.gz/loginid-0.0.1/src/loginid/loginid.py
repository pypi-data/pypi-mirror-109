...
class LoginID:
    ...
    def createTxId(self, tx_payload: str, username: str=None) -> Tuple[Union[Exception, int, None], str]:
        ...
        try:
            ...
            headers = {
                "Content-type": "application/json",
                "Authorization": "Bearer " + self.generateTxAuthToken(tx_payload, username=username)
            }
            payloads = dict(
                client_id=self._client_id,
                username=username,
