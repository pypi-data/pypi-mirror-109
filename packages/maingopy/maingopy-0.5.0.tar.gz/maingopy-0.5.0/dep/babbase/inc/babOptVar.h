 ...
 * @file babOptVar.h
 *
 * @brief File containing definitions related to the specification of optmization variables.
 *
 **********************************************************************************/
...
class OptimizationVariable {
  ...
  private:
    ...
    const Bounds _userSpecifiedBounds; /*!< bounds on the optimization variable as specified by the user (i.e., before potential rounding in case of discrete variables)*/
    const enums::VT _variableType;     /*!< optional: type of variable (default: enums::VT_CONTINUOUS) */
    const unsigned _branchingPriority; /*!< optional: whether this variable should be branched on (default: 1) */
    const std::string _name;           /*!< optional: name of the variable */
