...
<CAPTION><EM>Errors during construction of a FFToString are</EM></CAPTION>
     ...
     <TR><TH><tt>9</tt> <TD>Inconsistent size of subgradient between two mc::McCormick variables
     <TR><TH><tt>10</tt> <TD>A function is called although it is not supported by FFToString
     <TR><TH><tt>11</tt> <TD>Unknown writing language
</TABLE>
*/
