...
"""   
        ...
        if images is not None:
            ...
            for image_ind, image in enumerate(self.images):
                for slice_ind, image_slice in enumerate(normalize(slicing(image))):
                    imageio.imwrite(
        ...
        if masks is not None:
            ...
            for mask_ind, mask in enumerate(self.masks):
                for slice_ind, mask_slice in enumerate(slicing(self.decoder(mask))):
                    display_image_in_actual_size(mask_slice)
