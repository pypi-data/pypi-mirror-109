...
class GameView(arcade.View):
    ...
    def __init__(self, input_select):
        ...
        self.stats_path = 'miditeach/stats/' + datetime.now().strftime('%m%d%Y') + '.p'
    ...
    def setup(self):
        ...
        self.correct_sound = arcade.load_sound("miditeach/assets/sounds/correct.wav")
        self.wrong_sound = arcade.load_sound("miditeach/assets/sounds/wrong.wav")
