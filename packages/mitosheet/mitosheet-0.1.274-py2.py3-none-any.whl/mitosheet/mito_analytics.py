...
def log(log_event, params=None, install_mitosheets_pip_show=False):
    """
    ...
    NOTE: install_mitosheets_pip_show can be an expensive operation for some
    ...
    if install_mitosheets_pip_show:
