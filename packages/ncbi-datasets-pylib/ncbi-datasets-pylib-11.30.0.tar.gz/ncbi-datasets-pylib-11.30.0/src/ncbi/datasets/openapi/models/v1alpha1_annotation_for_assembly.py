...
class V1alpha1AnnotationForAssembly(object):
    ...
    def __init__(self, file=None, name=None, release_date=None, release_number=None, report_url=None, source=None, stats=None, local_vars_configuration=None):  # noqa: E501
