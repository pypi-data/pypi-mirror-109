...
def explain_diffs(old, new, indent="", prefix=""):
    ...
    The 'prefix' is added after the indent and an explaining comment,
    if there is one, followed by a line.  It is set to the empty string
    for 'ip access-list ...' (where no extra string is required) or
    something like 'ip prefix-list NAME', where these are required.
    ...
    inserte4d.  The lines without comments will create the new list.
    """
