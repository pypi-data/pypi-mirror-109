...
from ...app.doc_sent_importance.settings import DocSentImportanceModelSettings, DocSentImportanceCoachSettings
from ...app.doc_sent_importance.doc_sent_importance import DocSentImportance
...
def main():
    ...
    args = Utils.create_cmd_params(
        [DocSentImportanceCoachSettings(), DocSentImportanceModelSettings(), DeviceSettings()]
    )
    device_settings = DeviceSettings(gpu_idx=args.gpu_idx)
    coach_settings = DocSentImportanceCoachSettings(
    ...
    model_settings = DocSentImportanceModelSettings(
