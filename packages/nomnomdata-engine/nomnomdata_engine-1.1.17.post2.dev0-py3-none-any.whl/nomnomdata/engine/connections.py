...
DOAccessTokenConnection = Connection(
    alias="Digital Ocean Access Token",
    description="Personal Access Token or OAuth Token to access Digital Ocean REST API.",
    connection_type_uuid="DOKEY-ACCESS",
    categories=["Digital Ocean", "Access Token", "OAuth"],
    parameter_groups=[
        ParameterGroup(
            Parameter(
                type=Text(),
