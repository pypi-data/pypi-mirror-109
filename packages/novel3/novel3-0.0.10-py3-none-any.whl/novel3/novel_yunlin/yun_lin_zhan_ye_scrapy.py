...
class YuLinZhanYeScrapy:
    ...
    def __init__(self, db="sqlite") -> None:
        ...
        self.BOOK_LISTS = [
            "http://www.yulinzhanye9.com/shuku/0-lastupdate-0-%d.html" % i for i in range(0, 1054)]
    ...
    def visit_book_one_lists(self, url):
        ...
        for li in li_list:
            ...
            book_link = "http://www.yulinzhanye9.com" + \
        ...
        for book in book_list:
            ...
            for page in page_list:
                ...
                for li in li_list:
                    ...
                    chapter_link = "http://www.yulinzhanye9.com" + \
                                   li.xpath('a/@href')[0]
    ...
    def main(self):
        ...
        url_list = [
            "http://www.yulinzhanye9.com/shuku/0-lastupdate-0-%d.html" % i for i in range(1, 1089)]
        for url in url_list:
