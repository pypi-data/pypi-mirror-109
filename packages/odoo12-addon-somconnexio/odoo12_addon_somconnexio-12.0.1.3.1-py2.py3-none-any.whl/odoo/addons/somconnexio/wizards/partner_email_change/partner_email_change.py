...
class PartnerEmailChangeWizard(models.TransientModel):
    ...
    change_contracts_emails = fields.Selection(
        string="Change contracts emails",
        selection=boolean_selections,
        required=True
    )
    ...
    # Change OV email
    change_somoffice_email = fields.Selection(
        string="Change OV email",
        selection=boolean_selections,
        required=True
    )
    somoffice_email_id = fields.Many2one(
        'res.partner',
        string='OV Email',
    )
    ...
    def button_change(self):
        ...
        if self.change_somoffice_email == 'yes':
