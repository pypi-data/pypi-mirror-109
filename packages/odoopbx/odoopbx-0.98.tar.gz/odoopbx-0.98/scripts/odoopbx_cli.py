...
def install(service):
    if service == 'all':
        os.execvp('script', ['script', '-c', 'salt-call -l info state.highstate',
                             '/var/log/odoopbx-install.log'])
    else:
        os.execvp('script', ['script', '-c',
                             'salt-call -l info state.apply {}'.format(service),
                             '/var/log/odoopbx-install.log'])
