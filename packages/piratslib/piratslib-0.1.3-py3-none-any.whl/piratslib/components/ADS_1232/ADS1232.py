...
class ADS1232(ADC):
    ...
    def __init__(self):
        self.GAIN_PIN_0 = 13    # pin BCM  27
        self.GAIN_PIN_1 = 15    # pin BCM 22
        self.PWDN_PIN = 37      # pin BCM 26. cheapskate to enable power down
        self.SCLK_PIN = 32     # pin BCM 12 . SCLK pin
        self.TEMP_PIN = 7      # pin BCM 4
        self.SPEED_PIN = 22    # pin BCM 25
        self.ADDRESS_PIN = 33  # pin BCM 13   cheapskate at pin 17 to enable el A0 through pin 33
        self.INPUT_DATA_PIN = 28  # pin BCM 1
