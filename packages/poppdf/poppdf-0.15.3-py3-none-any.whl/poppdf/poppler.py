...
def image_info_from_path(
    pdf_path, userpw=None, poppler_path=None, timeout=None,  first_page=None, last_page=None, output_format='png'
):
    try:
        command = [_get_command_path("pdfimages", poppler_path), pdf_path]
