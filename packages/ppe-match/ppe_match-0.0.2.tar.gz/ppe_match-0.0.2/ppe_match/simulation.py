...
class Simulation:
	def __init__(self,
				...
				distance_matrix_path= "data/anon_distance_matrix.p",
		...
		self.distance_mat = pd.read_csv(os.path.join(dirname, distance_matrix_path), index_col=0)
