...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.2.0-alpha.1623845400+8a71108a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.2.0-alpha.1623845400+8a71108a`
                """)
            else:
                raise
