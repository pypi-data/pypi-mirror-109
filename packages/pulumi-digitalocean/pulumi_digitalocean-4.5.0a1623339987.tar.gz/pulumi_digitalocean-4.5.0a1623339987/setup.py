...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.5.0-alpha.1623339987+7adc69fe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.5.0-alpha.1623339987+7adc69fe`
                """)
            else:
                raise
