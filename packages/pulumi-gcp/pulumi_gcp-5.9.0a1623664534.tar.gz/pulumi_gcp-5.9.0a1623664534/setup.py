...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.9.0-alpha.1623664534+5b25abf1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.9.0-alpha.1623664534+5b25abf1`
                """)
            else:
                raise
