...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.9.0-alpha.1623845577+143ed8fc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.9.0-alpha.1623845577+143ed8fc`
                """)
            else:
                raise
