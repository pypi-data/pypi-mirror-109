...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'google-native', '0.3.1a1623832260'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource google-native 0.3.1a1623832260`
                """)
            else:
                raise
