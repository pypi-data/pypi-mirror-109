...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.1.0-alpha.1623669564+00d2e3bf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.1.0-alpha.1623669564+00d2e3bf`
                """)
            else:
                raise
