...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.2.0-alpha.1623845611+a70ed68e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.2.0-alpha.1623845611+a70ed68e`
                """)
            else:
                raise
