...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '1.1.0-alpha.1623845614+67cb3ee2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 1.1.0-alpha.1623845614+67cb3ee2`
                """)
            else:
                raise
