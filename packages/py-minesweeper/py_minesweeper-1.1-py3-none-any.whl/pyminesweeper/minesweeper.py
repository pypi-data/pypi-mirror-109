...
class MSGrid:
    ...
    def __repr__(self):
        return f"MSGrid(grid={self.getGridAsArray()})"
...
def run_tests():
    ...
    item = MSGridItem(b'0', False, False, 1, 2)
    item._test()
    del item
    print("MSGridItem Passed\nTesting MSGrid...")
    grid = MSGrid(10, 10)
    grid._test()
    del grid
    print("MSGrid Passed\nTesting MSEngine...")
    engine = MSEngine(10, 10, 10)
    engine._test()
    del engine
    print("MSEngine Passed")
