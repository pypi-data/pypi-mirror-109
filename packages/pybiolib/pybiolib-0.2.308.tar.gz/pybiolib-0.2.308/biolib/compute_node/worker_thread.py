...
class WorkerThread(threading.Thread):
    ...
    def _start_and_connect_to_compute_process(self):
        ...
        self.biolib_logger.debug(f"Trying to bind to socket on {SOCKET_HOST}:{self.socket_port}")
        self.socket.bind((SOCKET_HOST, self.socket_port))

        self.biolib_logger.debug(f"Starting to listen to socket on port {self.socket_port}")
        self.socket.listen()
        self.biolib_logger.debug(f"Listening to port {self.socket_port}")
        ...
        self.biolib_logger.debug("Starting connection thread")
        ...
        self.biolib_logger.debug("Started connection thread")
        self.biolib_logger.debug("Starting compute process")
