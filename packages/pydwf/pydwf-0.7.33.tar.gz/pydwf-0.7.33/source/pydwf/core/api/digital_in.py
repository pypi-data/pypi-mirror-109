...
class DigitalIn(AbstractDwfDeviceSubApi):
    ...
    def statusTime(self) -> Tuple[int, int, int]:
        """Get the |DigitalIn| status timestamp.
    ...
    def statusAutoTriggered(self) -> bool:
        """Verify if the |DigitalIn| acquisition is auto triggered.
    ...
    def statusSamplesLeft(self) -> int:
        """Retrieve the number of samples left in the |DigitalIn| acquisition.
    ...
    def statusSamplesValid(self) -> int:
        """Retrieve the number of valid/acquired |DigitalIn| data samples.
    ...
    def statusIndexWrite(self) -> int:
        """Retrieve the |DigitalIn| buffer write pointer.
    ...
    def statusRecord(self) -> Tuple[int, int, int]:
        """Get the |DigitalIn| recording status.
    ...
    def clockSourceInfo(self) -> List[DwfDigitalInClockSource]:
        """Get the valid |DigitalIn| clock sources.
    ...
    def triggerSourceInfo(self) -> List[DwfTriggerSource]:
        ...
        Note:
            This method is obsolete. Use the generic :py:meth:`DeviceControl.triggerInfo()` method instead.
