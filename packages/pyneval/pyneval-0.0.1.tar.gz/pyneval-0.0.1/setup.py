...
setup(name='pyneval',
      version='0.0.1',
      description='pyneval, a toolbox for quantitative metric on reconstructed neuron',
      author='HanZhang, TingZhao',
      ...
      py_modules=['pyneval', 'pyneval.cli', 'test', 'test.test_model',
                ...
                'pyneval.io', 'pyneval.metric', 'pyneval.metric.utils', 'pyneval.metric.utils.klib', 'pyneval.model',
                'pyneval.tools', 'pyneval.tools.optimize'],
      data_files=[('./lib/site-packages/config', glob.glob('config/*.json')),
                  ("./lib/site-packages/config/schemas", glob.glob('config/schemas/*.json'))],
      install_requires=[
            'anytree>=2.7.2',
            'kdtree>=0.16',
            'numpy>=1.0',
