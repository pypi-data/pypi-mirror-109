...
from selve.protocol import CommunicationType, DeviceClass, MethodCall, ScanState, SensorState, ServiceState, TeachState, lightDigital, rainDigital, tempDigital, windDigital
