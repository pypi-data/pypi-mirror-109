...
* get_dirs_files_local() / get_dirs_files_local()
* get_file_version_local() / get_file_version_local()
* get_file_size_local() / get_file_size_local()
* replace_text_local()
* get_md5() / get_available_hash_algorithm() / get_md5_local()
* get_xml_dom_local() / get_xml_tree_local()
