...
class NuisanceParameterPull(object):
    ...
    def run_pulls(self, input_file:str='workspace.root', workspace:str='combWS', model_config:str='ModelConfig',
                  data:str='combData', poi:str='', snapshot:str='nominalNuis', outdir:str='output', profile:str="",
                  fix:str='', minimizer_type:str='Minuit2', minimizer_algo:str='Migrad', num_cpu:int=1, 
                  binned:bool=1, precision:float=0.001, eps:float=1.0, log_level:str='INFO', eigen:bool=False, 
                  strategy:int=0, fix_cache:bool=True, fix_multi:bool=True, offset:bool=True, optimize:bool=True,
