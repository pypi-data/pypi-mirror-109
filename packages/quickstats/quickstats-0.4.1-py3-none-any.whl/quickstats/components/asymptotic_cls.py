...
class AsymptoticsCLs(AnalysisObject):
    ...
    def __init__(self, filename:str, poi_name:str=None, data_name:str='combData', 
                 ...
                 do_better_bands:bool=True, use_predictive_fit:bool=False,
        ...
        self.use_predictive_fit = use_predictive_fit
    ...
    def evaluate_limit_band(self, n:int, med_limit:float):
        ...
        n_times_sigma = self.get_limit(asimov_0_nll, mu_guess, 'nom_{}'.format(n))
        status = self.global_status
        ...
        asimov_data_n = self.model.generate_asimov(self.poi.GetName(), poi_val=n_times_sigma,
                                                   do_conditional=True)
        asimov_n_nll = self.pdf.createNLL(asimov_data_n, self.minimizer.nll_command_list)
    ...
    def evaluate_limits(self):
        ...
        self.reset()
        obs_nll = self.pdf.createNLL(self.data, self.minimizer.nll_command_list)
        ...
        asimov_0_nll = self.pdf.createNLL(asimov_data_0, self.minimizer.nll_command_list)
