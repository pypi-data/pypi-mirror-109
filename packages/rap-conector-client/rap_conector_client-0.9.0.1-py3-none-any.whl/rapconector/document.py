...
class DocumentSignature:
    ...
    def __repr__(self):
        return '{}(signer={}, tag={}, state={}, archiving_signature={}, ' \
            'substitute_signer={}, substitute_signature_state={})'.format(
                self.__class__.__name__, self.signer, self.tag, str(self.state),
                str(self.archiving_signature), self.substitute_signer,
                str(self.substitute_signature_state))
