...
setup(
    ...
    tests_require=['pytest>=3.0', 'graphviz', 'reahl-tofu>=5.1,<5.2', 'reahl-stubble>=5.1,<5.2', 'reahl-dev>=5.1,<5.2', 'reahl-sqlalchemysupport>=5.1,<5.2', 'reahl-sqlitesupport>=5.1,<5.2', 'reahl-mysqlsupport>=5.1,<5.2'],
