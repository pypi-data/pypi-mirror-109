...
setup(
    ...
    install_requires=['reahl-web>=5.1,<5.2', 'reahl-component>=5.1,<5.2', 'reahl-sqlalchemysupport>=5.1,<5.2', 'reahl-web-declarative>=5.1,<5.2', 'reahl-domain>=5.1,<5.2', 'reahl-domainui>=5.1,<5.2', 'reahl-commands>=5.1,<5.2', 'pytest>=3.0', 'setuptools>=32.3.1'],
