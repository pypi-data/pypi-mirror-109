...
setup(
    ...
    install_requires=['reahl-component>=5.1,<5.2', 'reahl-mailutil>=5.1,<5.2', 'reahl-sqlalchemysupport>=5.1,<5.2', 'reahl-web-declarative>=5.1,<5.2', 'passlib>=1.7.1,<1.7.9999'],
    setup_requires=['setuptools-git>=1.1', 'pytest-runner'],
    tests_require=['pytest>=3.0', 'reahl-tofu>=5.1,<5.2', 'reahl-stubble>=5.1,<5.2', 'reahl-dev>=5.1,<5.2', 'reahl-postgresqlsupport>=5.1,<5.2', 'reahl-webdev>=5.1,<5.2', 'reahl-browsertools>=5.1,<5.2'],
