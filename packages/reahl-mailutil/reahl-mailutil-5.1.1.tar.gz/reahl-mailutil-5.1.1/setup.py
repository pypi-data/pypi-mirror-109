...
setup(
    ...
    install_requires=['reahl-component>=5.1,<5.2', 'docutils>=0.14,<0.16.999', 'Pygments>=2.1.0,<2.6.999'],
    setup_requires=['setuptools-git>=1.1', 'pytest-runner'],
    tests_require=['pytest>=3.0', 'reahl-tofu>=5.1,<5.2', 'reahl-dev>=5.1,<5.2', 'reahl-stubble>=5.1,<5.2'],
