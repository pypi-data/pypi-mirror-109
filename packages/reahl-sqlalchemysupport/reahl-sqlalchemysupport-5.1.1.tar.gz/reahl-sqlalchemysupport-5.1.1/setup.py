...
setup(
    ...
    install_requires=['reahl-component>=5.1,<5.2', 'reahl-commands>=5.1,<5.2', 'SQLAlchemy>=1.2.0,<1.3.999', 'alembic>=0.9.6,<1.4.999'],
    setup_requires=['setuptools-git>=1.1', 'pytest-runner'],
    tests_require=['pytest>=3.0', 'reahl-tofu>=5.1,<5.2', 'reahl-sqlitesupport>=5.1,<5.2', 'reahl-domain>=5.1,<5.2', 'reahl-dev>=5.1,<5.2', 'reahl-stubble>=5.1,<5.2'],
