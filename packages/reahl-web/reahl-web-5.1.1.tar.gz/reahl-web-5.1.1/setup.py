...
setup(
    ...
    install_requires=['reahl-component>=5.1,<5.2', 'reahl-mailutil>=5.1,<5.2', 'ply>=3.8,<3.11.999', 'slimit>=0.8,<0.8.999', 'cssmin>=0.2,<0.2.999', 'beautifulsoup4>=4.6,<4.6.999', 'WebOb>=1.8,<1.8.999', 'Babel>=2.1,<2.8.999', 'setuptools>=32.3.1', 'lxml>=4.2,<4.5.999'],
    setup_requires=['setuptools-git>=1.1', 'pytest-runner'],
    tests_require=['pytest>=3.0', 'reahl-tofu>=5.1,<5.2', 'reahl-stubble>=5.1,<5.2', 'reahl-sqlalchemysupport>=5.1,<5.2', 'reahl-postgresqlsupport>=5.1,<5.2', 'reahl-web-declarative>=5.1,<5.2', 'reahl-domain>=5.1,<5.2', 'reahl-webdev>=5.1,<5.2', 'reahl-browsertools>=5.1,<5.2', 'reahl-dev>=5.1,<5.2'],
