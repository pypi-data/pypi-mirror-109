...
class TopologyReader:
        ...
        if isinstance(component, str):
            try:
                ...
                try:
                    ...
                    raise ValueError(
                        f"No component found for service '{component}' at either '{str(e1.path_str)}' or '{str(e2.path_str)}"
                    )
            ...
            if component_base_path:
                ...
                try:
                    ...
                    try:
                        ...
                        raise ValueError(
                            f"No k8s container spec file found for Service '{component}' at either '{str(e1.path_str)}' or '{str(e2.path_str)}"
                        )
    ...
    def _load_component_hook(
        ...
        try:
            ...
            self.logger.debug(f"No {hook_name} hook found at '{e.path_str}'")
