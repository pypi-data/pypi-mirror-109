...
class EnsembleFractureStatisticsPlotCollection(PdmObjectBase):
    __custom_init__ = None #: Assign a custom init routine to be run at __init__

    def __init__(self, pb2_object=None, channel=None):
        PdmObjectBase.__init__(self, pb2_object, channel)
        if EnsembleFractureStatisticsPlotCollection.__custom_init__ is not None:
            EnsembleFractureStatisticsPlotCollection.__custom_init__(self, pb2_object=pb2_object, channel=channel)

    def ensemble_fracture_statistics_plots(self):
        """

        Returns:
             List of EnsembleFractureStatisticsPlot
        """
        return self.children("EnsembleFractureStatisticsPlots", EnsembleFractureStatisticsPlot)
...
class FaciesProperties(PdmObjectBase):
    ...
    def __init__(self, pb2_object=None, channel=None):
        self.color_legend = "ColorLegend:1947727671344"
        self.file_path = ""
        self.properties_table = ""
        PdmObjectBase.__init__(self, pb2_object, channel)
...
def class_dict():
    ...
    classes['EnsembleFractureStatisticsPlotCollection'] = EnsembleFractureStatisticsPlotCollection
