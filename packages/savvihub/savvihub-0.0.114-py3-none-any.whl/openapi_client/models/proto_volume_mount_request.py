...
class ProtoVolumeMountRequest(object):
    ...
    def __init__(self, dataset=None, empty_dir=None, host_path=None, mount_path=None, mount_type=None, nfs=None, output=None, project=None, readonly=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mount_type(self, mount_type):
        ...
        allowed_values = ["empty-dir", "project", "dataset", "output", "volume", "nfs", "host-path"]  # noqa: E501
