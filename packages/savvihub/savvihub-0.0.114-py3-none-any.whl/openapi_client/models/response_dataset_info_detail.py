...
class ResponseDatasetInfoDetail(object):
    ...
    attribute_map = {
        ...
        'is_support_version': 'is_support_version',
        'name': 'name',
    ...
    def __init__(self, created_dt=None, dataset_organization=None, dataset_volume=None, description=None, file_count=None, id=None, immutable_slug=None, is_public=None, is_read_only=None, is_support_version=None, name=None, organization=None, organization_id=None, size=None, source=None, status=None, summary=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.is_support_version = is_support_version
        self.name = name
    ...
    @property
    def is_support_version(self):
        """Gets the is_support_version of this ResponseDatasetInfoDetail.  # noqa: E501


        :return: The is_support_version of this ResponseDatasetInfoDetail.  # noqa: E501
        :rtype: bool
        """
        return self._is_support_version

    @is_support_version.setter
    def is_support_version(self, is_support_version):
        """Sets the is_support_version of this ResponseDatasetInfoDetail.


        :param is_support_version: The is_support_version of this ResponseDatasetInfoDetail.  # noqa: E501
        :type is_support_version: bool
        """
        if self.local_vars_configuration.client_side_validation and is_support_version is None:  # noqa: E501
            raise ValueError("Invalid value for `is_support_version`, must not be `None`")  # noqa: E501

        self._is_support_version = is_support_version
