...
function DebugFileCustomRepository(_a) {
    var Header = _a.Header, Body = _a.Body, Footer = _a.Footer, onSave = _a.onSave, sourceConfig = _a.sourceConfig, sourceType = _a.sourceType, _b = _a.params, orgId = _b.orgId, projectSlug = _b.projectId, location = _a.location, appStoreConnectContext = _a.appStoreConnectContext;
