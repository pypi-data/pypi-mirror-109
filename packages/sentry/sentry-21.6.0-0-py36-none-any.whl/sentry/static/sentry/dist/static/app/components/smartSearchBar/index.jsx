...
var SmartSearchBar = /** @class */ (function (_super) {
    ...
    function SmartSearchBar() {
        ...
        _this.onQueryChange = function (evt) {
            ...
            _this.setState({ query: query }, _this.updateAutoCompleteItems);
    ...
    SmartSearchBar.prototype.render = function () {
        ...
        var input = (<SearchInput type="text" placeholder={placeholder} id="smart-search-input" name="query" ref={this.searchInput} autoComplete="off" value={this.state.query} onFocus={this.onQueryFocus} onBlur={this.onQueryBlur} onKeyUp={this.onKeyUp} onKeyDown={this.onKeyDown} onChange={this.onQueryChange} onClick={this.onInputClick} disabled={disabled} maxLength={maxQueryLength} spellCheck={false} hiddenText={hasSyntaxHighlight}/>);
        ...
        <ActionsBar gap={0.5}>
          ...
          {(hasPinnedSearch || canCreateSavedSearch || hasSearchBuilder) && (<StyledDropdownLink anchorRight caret={false} title={<InputButton size="zero" borderless tooltipProps={{
        ...
        {(this.state.loading || this.state.searchGroups.length > 0) && (<SearchDropdown css={{ display: this.state.dropdownVisible ? 'block' : 'none' }} className={dropdownClassName} items={this.state.searchGroups} onClick={this.onAutoComplete} loading={this.state.loading} searchSubstring={this.state.searchTerm}/>)}
      </Container>);
    };
    /**
...
var InputWrapper = styled('div')(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
...
})(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  resize: none;\n  outline: none;\n  border: 0;\n  width: 100%;\n  padding: 0;\n  line-height: 25px;\n  margin-bottom: -1px;\n  background: transparent;\n  font-size: ", ";\n  font-family: ", ";\n  caret-color: ", ";\n\n  ", ";\n\n  &::selection {\n    background: rgba(0, 0, 0, 0.2);\n  }\n  &::placeholder {\n    color: ", ";\n  }\n\n  [disabled] {\n    color: ", ";\n  }\n"], ["\n  position: relative;\n  display: flex;\n  resize: none;\n  outline: none;\n  border: 0;\n  width: 100%;\n  padding: 0;\n  line-height: 25px;\n  margin-bottom: -1px;\n  background: transparent;\n  font-size: ", ";\n  font-family: ", ";\n  caret-color: ", ";\n\n  ", ";\n\n  &::selection {\n    background: rgba(0, 0, 0, 0.2);\n  }\n  &::placeholder {\n    color: ", ";\n  }\n\n  [disabled] {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.fontSizeSmall; }, function (p) { return p.theme.text.familyMono; }, function (p) { return p.theme.subText; }, function (p) { return p.hiddenText && 'color: transparent'; }, function (p) { return p.theme.formPlaceholder; }, function (p) { return p.theme.disabled; });
...
var VerticalEllipsisIcon = styled(IconEllipsis)(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  transform: rotate(90deg);\n"], ["\n  transform: rotate(90deg);\n"])));
var SearchLabel = styled('label')(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n  display: flex;\n  padding: ", " 0;\n  margin: 0;\n  color: ", ";\n"], ["\n  display: flex;\n  padding: ", " 0;\n  margin: 0;\n  color: ", ";\n"])), space(0.5), function (p) { return p.theme.gray300; });
var ActionsBar = styled(ButtonBar)(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  height: ", ";\n  margin: ", " 0;\n"], ["\n  height: ", ";\n  margin: ", " 0;\n"])), space(2), space(0.5));
