...
import { aggregateOutputType, generateFieldAsString, getAggregateAlias, getEquation, isAggregateField, isEquation, isLegalYAxisType, } from './fields';
...
var EventView = /** @class */ (function () {
    ...
    EventView.prototype.getEventsAPIPayload = function (location) {
        ...
        var fields = this.getFields().filter(function (field) { return !isEquation(field); });
        ...
        var eventQuery = Object.assign(omit(picked, DATETIME_QUERY_STRING_KEYS), normalizedTimeWindowParams, {
            ...
            equation: __spreadArray([], __read(new Set(equations))),
            sort: sort,
    ...
    EventView.prototype.getYAxisOptions = function () {
        ...
        return uniqBy(this.getAggregateFields()
            ...
            return isLegalYAxisType(aggregateOutputType(field.field)) && !isEquation(field.field);
        })
...
export var isAPIPayloadSimilar = function (current, other) {
    ...
    try {
        for (var currentKeys_1 = __values(currentKeys), currentKeys_1_1 = currentKeys_1.next(); !currentKeys_1_1.done; currentKeys_1_1 = currentKeys_1.next()) {
            ...
            var currentTarget = Array.isArray(currentValue) && key !== 'equation'
                ? new Set(currentValue)
                : currentValue;
            var otherValue = other[key];
            var otherTarget = Array.isArray(otherValue) && key !== 'equation' ? new Set(otherValue) : otherValue;
