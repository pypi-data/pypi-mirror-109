...
var AlertListRow = /** @class */ (function (_super) {
    ...
    AlertListRow.prototype.render = function () {
        var _a;
        var _b = this.props, incident = _b.incident, orgId = _b.orgId, projectsLoaded = _b.projectsLoaded, projects = _b.projects, organization = _b.organization;
            ...
            <Title>
              ...
              <div>
                ...
                ? tct('Active for [duration]', {
                    duration: (<Duration seconds={getDynamicText({ value: duration, fixed: 1200 })}/>),
                })
                : t('Still Active')}
              </div>
            </Title>
...
var ProjectBadge = styled(IdBadge)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  flex-shrink: 0;\n"], ["\n  flex-shrink: 0;\n"])));
var StyledTimeSeparator = styled('span')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (p) { return p.theme.gray200; });
var Title = styled('span')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), overflowEllipsis);
var IncidentPanelItem = styled(PanelItem)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  font-size: ", ";\n"], ["\n  font-size: ", ";\n"])), function (p) { return p.theme.fontSizeMedium; });
var FlexCenter = styled('div')(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
