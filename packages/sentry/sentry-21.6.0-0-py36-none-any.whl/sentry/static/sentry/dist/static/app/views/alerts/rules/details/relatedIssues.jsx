...
var RelatedIssues = /** @class */ (function (_super) {
    ...
    RelatedIssues.prototype.render = function () {
        ...
        var queryParams = __assign(__assign({ start: start,
            end: end, groupStatsPeriod: 'auto', limit: 5 }, (rule.environment ? { environment: rule.environment } : {})), { sort: rule.aggregate === 'count_unique(user)' ? 'user' : 'freq', query: [
                rule.query,
