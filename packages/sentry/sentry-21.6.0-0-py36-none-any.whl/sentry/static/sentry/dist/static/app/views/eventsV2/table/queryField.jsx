...
var QueryField = /** @class */ (function (_super) {
    ...
    QueryField.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, takeFocus = _a.takeFocus, filterPrimaryOptions = _a.filterPrimaryOptions, fieldValue = _a.fieldValue, inFieldLabels = _a.inFieldLabels, disabled = _a.disabled, hidePrimarySelector = _a.hidePrimarySelector, gridColumns = _a.gridColumns;
        ...
        if (fieldValue.kind === FieldValueKind.EQUATION) {
            return (<Container className={className} gridColumns={1}>
          <BufferedInput name="refinement" key="parameter:text" type="text" required value={fieldValue.field} onUpdate={this.handleEquationChange}/>
        </Container>);
        }
