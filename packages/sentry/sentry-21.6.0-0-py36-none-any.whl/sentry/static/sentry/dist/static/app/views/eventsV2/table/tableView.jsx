...
var TableView = /** @class */ (function (_super) {
    ...
    function TableView() {
        ...
        _this._renderGridHeaderCell = function (column) {
            ...
            var sortLink = (<SortLink align={align} title={column.name} direction={currentSort ? currentSort.kind : undefined} canSort={canSort} generateSortLink={generateSortLink}/>);
            if (isEquationAlias(column.name)) {
                return (<Tooltip title={eventView.getEquations()[getEquationAliasIndex(column.name)]}>
          {sortLink}
        </Tooltip>);
            }
            return sortLink;
