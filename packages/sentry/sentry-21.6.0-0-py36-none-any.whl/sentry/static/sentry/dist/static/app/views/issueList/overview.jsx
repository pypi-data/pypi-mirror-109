        ...
        {function (_a) {
            ...
            <StyledPageContent isInbox={hasFeature}>
              <StreamContent showSidebar={isSidebarVisible}>
                <IssueListFilters organization={organization} query={query} savedSearch={savedSearch} sort={_this.getSort()} display={_this.getDisplay()} queryCount={queryCount} queryMaxCount={queryMaxCount} onDisplayChange={_this.onDisplayChange} onSortChange={_this.onSortChange} onSearch={_this.onSearch} onSavedSearchSelect={_this.onSavedSearchSelect} onSavedSearchDelete={_this.onSavedSearchDelete} onSidebarToggle={_this.onSidebarToggle} isSearchDisabled={isSidebarVisible} savedSearchList={savedSearches} tagValueLoader={_this.tagValueLoader} tags={tags} isInbox={hasFeature} hasSessions={hasSessions} selectedProjects={selection.projects}/>
