...
var GroupMergedView = /** @class */ (function (_super) {
    ...
    GroupMergedView.prototype.getEndpoint = function () {
        ...
        var queryParams = __assign(__assign({}, location.query), { limit: 50, query: this.state.query });
    ...
    GroupMergedView.prototype.render = function () {
        ...
        {isLoadedSuccessfully && (<MergedList project={project} fingerprints={mergedItems} pageLinks={mergedLinks} groupId={groupId} onUnmerge={this.handleUnmerge} onSplit={this.handleSplit} onToggleCollapse={GroupingActions.toggleCollapseFingerprints}/>)}
      </Fragment>);
    };
