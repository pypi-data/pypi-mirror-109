...
function MergedList(_a) {
    var _b = _a.fingerprints, fingerprints = _b === void 0 ? [] : _b, pageLinks = _a.pageLinks, onToggleCollapse = _a.onToggleCollapse, onUnmerge = _a.onUnmerge, onSplit = _a.onSplit, organization = _a.organization, groupId = _a.groupId, project = _a.project;
    ...
    return (<Fragment>
      ...
      <Panel>
        <MergedToolbar onToggleCollapse={onToggleCollapse} onUnmerge={onUnmerge} onSplit={onSplit} orgId={organization.slug} project={project} groupId={groupId}/>
