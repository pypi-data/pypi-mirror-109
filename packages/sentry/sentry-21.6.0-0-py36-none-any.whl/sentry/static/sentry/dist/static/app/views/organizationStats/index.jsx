...
var OrganizationStats = /** @class */ (function (_super) {
    ...
    function OrganizationStats() {
        ...
        _this.renderPageControl = function () {
            ...
            var isCalendarOpen = _this.state.isCalendarOpen;
        ...
        <DropdownDate isCalendarOpen={isCalendarOpen}>
          <TimeRangeSelector organization={organization} relative={period !== null && period !== void 0 ? period : ''} start={start !== null && start !== void 0 ? start : null} end={end !== null && end !== void 0 ? end : null} utc={utc !== null && utc !== void 0 ? utc : null} label={<DropdownLabel>{t('Date Range:')}</DropdownLabel>} onChange={function () { }} onUpdate={_this.handleUpdateDatetime} onToggleSelector={function (isOpen) { return _this.setState({ isCalendarOpen: isOpen }); }} relativeOptions={omit(DEFAULT_RELATIVE_PERIODS, ['1h'])} defaultPeriod={DEFAULT_STATS_PERIOD}/>
        </DropdownDate>
...
}, function (p) { return p.theme.fontSizeMedium; }, function (p) { return p.theme.textColor; }, function (p) { return p.theme.zIndex.globalSelectionHeader; }, space(2), function (p) { return p.theme.breakpoints[0]; }, function (p) { return p.theme.breakpoints[2]; });
