...
function ProjectIssues(_a) {
    ...
    function getDiscoverUrl() {
        return {
            ...
            query: __assign({ name: t('Frequent Unhandled Issues'), field: ['issue', 'title', 'count()', 'count_unique(user)', 'project'], sort: ['-count'], query: 'event.type:error error.unhandled:true', display: 'top5' }, getParams(pick(location.query, __spreadArray([], __read(Object.values(URL_PARAM)))))),
        };
    }
