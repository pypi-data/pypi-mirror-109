...
var ReleaseAdoptionChart = /** @class */ (function (_super) {
    ...
    ReleaseAdoptionChart.prototype.getEndpoints = function () {
        ...
        return [
            [
                ...
                {
                    query: __assign(__assign({ interval: getInterval({
                        ...
                        }) }, getParams(pick(location.query, Object.values(URL_PARAM)))), { groupBy: ['release'], field: [sessionDisplayToField(activeDisplay)], query: location.query.query ? "release:" + location.query.query : undefined }),
                },
            ],
        ];
    };
    ...
    ReleaseAdoptionChart.prototype.render = function () {
        ...
        var _c = this.state, loading = _c.loading, reloading = _c.reloading;
