...
var RangeSlider = /** @class */ (function (_super) {
    ...
    RangeSlider.prototype.render = function () {
        ...
        var _b = this.props, name = _b.name, disabled = _b.disabled, allowedValues = _b.allowedValues, formatLabel = _b.formatLabel, placeholder = _b.placeholder, showCustomInput = _b.showCustomInput, className = _b.className;
