...
var ContextData = /** @class */ (function (_super) {
    ...
    ContextData.prototype.renderValue = function (value) {
        var _a = this.props, preserveQuotes = _a.preserveQuotes, meta = _a.meta, withAnnotatedText = _a.withAnnotatedText, jsonConsts = _a.jsonConsts, maxDefaultDepth = _a.maxDefaultDepth, onToggle = _a.onToggle;
        ...
        function walk(value, depth) {
            ...
            <Toggle highUp={depth <= maxDepth} wrapClassName="val-array-items" onClick={onToggle}>
              {children}
            </Toggle>
            <span className="val-array-marker">{']'}</span>
          </span>);
          ...
          <Toggle highUp={depth <= maxDepth - 1} onClick={onToggle} wrapClassName="val-dict-items">
            {children}
          </Toggle>
          <span className="val-dict-marker">{'}'}</span>
        </span>);
