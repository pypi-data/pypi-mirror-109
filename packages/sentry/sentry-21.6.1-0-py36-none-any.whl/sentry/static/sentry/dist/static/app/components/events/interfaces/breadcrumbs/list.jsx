...
var ListContainer = /** @class */ (function (_super) {
    ...
    ListContainer.prototype.renderBody = function (breadcrumb, isLastItem) {
        ...
        return (<ListBody orgId={orgId} searchTerm={searchTerm} breadcrumb={breadcrumb} event={event} relativeTime={relativeTime} displayRelativeTime={displayRelativeTime} isLastItem={isLastItem} onToggle={this.updateGrid}/>);
    };
