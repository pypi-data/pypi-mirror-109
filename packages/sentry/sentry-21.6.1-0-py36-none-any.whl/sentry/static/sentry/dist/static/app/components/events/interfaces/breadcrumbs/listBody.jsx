...
var ListBody = memo(function (_a) {
    var orgId = _a.orgId, event = _a.event, breadcrumb = _a.breadcrumb, relativeTime = _a.relativeTime, displayRelativeTime = _a.displayRelativeTime, searchTerm = _a.searchTerm, isLastItem = _a.isLastItem, onToggle = _a.onToggle;
    ...
    return (<Fragment>
        ...
        <GridCell hasError={hasError} isLastItem={isLastItem}>
          <Data event={event} orgId={orgId} breadcrumb={breadcrumb} searchTerm={searchTerm} onToggle={onToggle}/>
        </GridCell>
        <GridCell hasError={hasError} isLastItem={isLastItem}>
