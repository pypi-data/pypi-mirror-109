...
var TraceView = /** @class */ (function (_super) {
    ...
    function TraceView(props) {
        ...
        _this.renderHeader = function (dragProps, parsedTrace) { return (<TraceViewHeader organization={_this.props.organization} minimapInteractiveRef={_this.minimapInteractiveRef} dragProps={dragProps} trace={parsedTrace} event={_this.props.event} virtualScrollBarContainerRef={_this.virtualScrollBarContainerRef} operationNameFilters={_this.props.operationNameFilters}/>); };
        _this.state = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        transformed = __spreadArray([generateRootSpan(parsedTrace)], __read(spans)).map(function (span) {
                            var _a;
                            var indexed = [];
                            // basic properties
    ...
    TraceView.prototype.render = function () {
        ...
        var _b = this.props, organization = _b.organization, operationNameFilters = _b.operationNameFilters;
              ...
              <DividerHandlerManager.Consumer>
                {function (dividerHandlerChildrenProps) {
                    return (<ScrollbarManager.Provider dividerPosition={dividerHandlerChildrenProps.dividerPosition} interactiveLayerRef={_this.virtualScrollBarContainerRef} dragProps={dragProps}>
                      ...
                      <SpanTree traceViewRef={_this.traceViewRef} event={event} trace={parsedTrace} dragProps={dragProps} filterSpans={_this.state.filterSpans} organization={organization} operationNameFilters={operationNameFilters}/>
