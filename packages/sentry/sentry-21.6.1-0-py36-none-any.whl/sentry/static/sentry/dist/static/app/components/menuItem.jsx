...
var MenuItem = /** @class */ (function (_super) {
    ...
    function MenuItem() {
        ...
        _this.handleClick = function (e) {
            var _a = _this.props, onSelect = _a.onSelect, disabled = _a.disabled, eventKey = _a.eventKey, allowDefaultEvent = _a.allowDefaultEvent, stopPropagation = _a.stopPropagation;
            if (disabled) {
                return;
            }
            if (onSelect) {
