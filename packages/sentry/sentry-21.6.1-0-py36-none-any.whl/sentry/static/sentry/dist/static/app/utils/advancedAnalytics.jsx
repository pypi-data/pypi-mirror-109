 ...
 */
export function trackAdvancedAnalyticsEvent(eventKey, analyticsParams, org, // if org is undefined, event won't be recorded
options, mapValuesFn) {
    try {
        ...
        var params = __assign({ eventKey: eventKey,
            eventName: eventName, analytics_session_id: sessionId, organization_id: organization_id, role: org === null || org === void 0 ? void 0 : org.role, custom_referrer: custom_referrer }, analyticsParams);
        if (mapValuesFn) {
