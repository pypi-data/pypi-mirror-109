...
var IncidentsList = /** @class */ (function (_super) {
    ...
    IncidentsList.prototype.getQueryStatus = function (status) {
        ...
        var hasAlertHistoryFilters = this.props.organization.features.includes('alert-history-filters');
        ...
        {(_a = this.tryRenderOnboarding()) !== null && _a !== void 0 ? _a : (<Panel>
            {!loading && (<PanelHeader>
                <TableLayout>
                  ...
                  <div>{t('Project')}</div>
                  <div>
                    <Feature features={['team-alerts-ownership']} organization={organization}>
                      {t('Team')}
                    </Feature>
                  </div>
                </TableLayout>
    ...
    IncidentsList.prototype.renderBody = function () {
        var _a = this.props, params = _a.params, organization = _a.organization, router = _a.router, location = _a.location;
        ...
        var status = this.getQueryStatus(location.query.status)[0] || DEFAULT_QUERY_STATUS;
        var hasAlertHistoryFilters = organization.features.includes('alert-history-filters');
          ...
          <StyledLayoutBody>
            <Layout.Main fullWidth>
              {!this.tryRenderOnboarding() && (<Fragment>
                  ...
                  {hasAlertHistoryFilters ? (this.renderFilterBar()) : (<StyledButtonBar merged active={status}>
...
var StyledLayoutBody = styled(Layout.Body)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  margin-bottom: -20px;\n"], ["\n  margin-bottom: -20px;\n"])));
