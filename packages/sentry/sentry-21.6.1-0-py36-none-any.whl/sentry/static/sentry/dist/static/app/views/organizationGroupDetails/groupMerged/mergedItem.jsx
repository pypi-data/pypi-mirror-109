...
var MergedItem = /** @class */ (function (_super) {
    ...
    MergedItem.prototype.render = function () {
        ...
        var latestEvent = fingerprint.latestEvent, id = fingerprint.id, label = fingerprint.label, children = fingerprint.children;
        ...
        <Controls expanded={!collapsed}>
          <ActionWrapper onClick={this.handleToggle}>
            <Checkbox id={id} value={id} checked={checked} disabled={checkboxDisabled} onChange={this.handleCheckClick}/>
        ...
        {!collapsed && (<MergedEventList className="event-list">
            {latestEvent && (<EventDetails className="event-details">
                <EventOrGroupHeader data={latestEvent} organization={organization} hideIcons hideLevel/>
              </EventDetails>)}

            {!!(children === null || children === void 0 ? void 0 : children.length) && (<ChildGroup>
                {children.map(function (_a) {
                        var childId = _a.childId, childLabel = _a.childLabel, childLatestEvent = _a.latestEvent;
                        return (<ListItem key={childId}>
                    <FingerprintLabel htmlFor={childId}>
                      {_this.renderFingerprint(childId, childLabel)}
                    </FingerprintLabel>
                    {childLatestEvent && (<EventDetails className="event-details">
                        <EventOrGroupHeader data={childLatestEvent} organization={organization} hideIcons hideLevel/>
                      </EventDetails>)}
                  </ListItem>);
                    })}
              </ChildGroup>)}
...
var FingerprintLabel = styled('label')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  font-family: ", ";\n\n  ", " & {\n    font-weight: 400;\n    margin: 0;\n  }\n"], ["\n  font-family: ", ";\n\n  " /* sc-selector */, " & {\n    font-weight: 400;\n    margin: 0;\n  }\n"])), function (p) { return p.theme.text.familyMono; }, /* sc-selector */ Controls);
...
var ChildGroup = styled(List)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  list-style: none;\n  padding: ", " 0 0 ", ";\n  border-top: 1px solid ", ";\n"], ["\n  list-style: none;\n  padding: ", " 0 0 ", ";\n  border-top: 1px solid ", ";\n"])), space(0.5), space(4), function (p) { return p.theme.innerBorder; });
