...
function GroupingContainer(_a) {
    var organization = _a.organization, params = _a.params, location = _a.location, project = _a.project;
    return (<Feature features={['grouping-tree-ui']} organization={organization} renderDisabled={function () { return (<PageContent>
      ...
      <Grouping location={location} groupId={params.groupId} organization={organization} project={project}/>
    </Feature>);
}
