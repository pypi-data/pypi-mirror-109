    ...
    ProjectCharts.prototype.render = function () {
        ...
        <ChartContainer>
          {!defined(hasSessions) ? (<LoadingPanel />) : (<Fragment>
              {displayMode === DisplayModes.APDEX && (<ProjectBaseEventsChart title={t('Apdex')} help={getTermHelp(organization, apdexPerformanceTerm)} query="event.type:transaction" yAxis={apdexYAxis} field={[apdexYAxis]} api={api} router={router} organization={organization} onTotalValuesChange={this.handleTotalValuesChange} colors={[CHART_PALETTE[0][0], theme.purple200]}/>)}
