...
var ReleasesList = /** @class */ (function (_super) {
    ...
    ReleasesList.prototype.renderHealthCta = function () {
        ...
        var _c = this.state, hasSessions = _c.hasSessions, releases = _c.releases;
        var selectedProjectId = selection.projects && selection.projects.length === 1 && selection.projects[0];
        var selectedProject = (_a = organization.projects) === null || _a === void 0 ? void 0 : _a.find(function (p) { return p.id === "" + selectedProjectId; });
        if (!selectedProject || hasSessions !== false || !(releases === null || releases === void 0 ? void 0 : releases.length)) {
            return null;
        }
        return (<Feature features={['organizations:release-adoption-chart']}>
        <Projects orgId={organization.slug} slugs={[selectedProject.slug]}>
          {function (_a) {
                ...
                <AlertText>
                  <div>
                    {t('Setup Release Health for this project to view user adoption, usage of the application, percentage of crashes, and session data.')}
                  </div>
    ...
    ReleasesList.prototype.renderInnerBody = function (activeDisplay) {
        ...
        {function (_a) {
                ...
                return (<Fragment>
              {singleProjectSelected && hasSessions && (<Feature features={['organizations:release-adoption-chart']}>
        ...
        <PageContent>
          <LightWeightNoProjectMessage organization={organization}>
            ...
            <SortAndFilterWrapper>
              ...
              <ReleaseListSortOptions selected={activeSort} onSelect={this.handleSortBy} organization={organization}/>
