    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_area_name', models.CharField(blank=True, default='', help_text='原产地（国）名称', max_length=50, null=True, verbose_name='原产地（国）名称')),
                ('natcd', models.CharField(blank=True, help_text='国别', max_length=10, null=True, verbose_name='国别')),
                ('natcd_name', models.CharField(blank=True, help_text='国别名称', max_length=10, null=True, verbose_name='国别名称')),
                ('unit', models.CharField(blank=True, help_text='数量单位', max_length=20, null=True, verbose_name='数量单位')),
                ('unit_name', models.CharField(blank=True, help_text='数量单位名称', max_length=20, null=True, verbose_name='数量单位名称')),
                ('g_unit', models.CharField(blank=True, help_text='申报单位', max_length=20, null=True, verbose_name='申报单位')),
                ('g_unit_name', models.CharField(blank=True, help_text='申报单位名称', max_length=20, null=True, verbose_name='申报单位名称')),
                ('unit_1', models.CharField(blank=True, help_text='法定单位', max_length=20, null=True, verbose_name='法定单位')),
                ('unit_1_name', models.CharField(blank=True, help_text='法定单位名称', max_length=20, null=True, verbose_name='法定单位名称')),
                ('unit_2', models.CharField(blank=True, help_text='法定第二单位', max_length=20, null=True, verbose_name='法定第二单位')),
                ('unit_2_name', models.CharField(blank=True, help_text='法定第二单位名称', max_length=20, null=True, verbose_name='法定第二单位名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account', models.CharField(help_text='银行账号', max_length=40, verbose_name='银行账号')),
                ('bank_name', models.CharField(help_text='开户行', max_length=40, verbose_name='开户行')),
                ('bank_no', models.CharField(blank=True, help_text='银行编码', max_length=40, null=True, verbose_name='银行编码')),
                ('invoice_title', models.CharField(help_text='发票抬头', max_length=500, verbose_name='发票抬头')),
                ('contacts', models.CharField(help_text='联系人', max_length=40, verbose_name='联系人')),
                ('contact_num', models.CharField(help_text='联系电话', max_length=40, verbose_name='联系电话')),
                ('if_deleted', models.BooleanField(default=False, verbose_name='是否删除')),
