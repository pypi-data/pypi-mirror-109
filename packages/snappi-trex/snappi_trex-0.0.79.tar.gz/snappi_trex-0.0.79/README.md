...
T-Rex must be installed in order to use snappi_trex. For a quick tutorial on T-Rex installation, running, and basic usage, check out my [T-Rex Tutorial](https://github.com/fredpower44/T-Rex-Tutorial)
