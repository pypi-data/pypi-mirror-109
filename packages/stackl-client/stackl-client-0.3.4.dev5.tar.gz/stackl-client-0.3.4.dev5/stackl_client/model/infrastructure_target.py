...
class InfrastructureTarget(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, location, zone, *args, **kwargs):  # noqa: E501
        """InfrastructureTarget - a model defined in OpenAPI
