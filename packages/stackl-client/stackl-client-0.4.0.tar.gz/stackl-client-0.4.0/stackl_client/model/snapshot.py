...
class Snapshot(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): [optional] if omitted the server will use the default value of "This is a snapshot of a document as given in the K/V snapshot"  # noqa: E501
            snapshot (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            type (str): [optional] if omitted the server will use the default value of "snapshot"  # noqa: E501
            category (str): [optional] if omitted the server will use the default value of "history"  # noqa: E501
        """
