...
class Superwise:
    ...
    def __init__(
        ...
        self.task = TaskController(_rest_client)
        self.version = VersionController(_rest_client)
        self.role = RoleController(_rest_client)
        self.data_entity = DataEntityController(_rest_client)
