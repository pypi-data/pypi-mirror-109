...
class AsyncApi(object):
    ...
    def add_audio_with_http_info(self, body, content_type, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'content_type', 'name', 'webhook_url', 'custom_vocabulary', 'confidence_threshold', 'custom_entities', 'detect_entities', 'detect_phrases', 'enable_separate_recognition_per_channel', 'channel_metadata', 'language_code', 'mode', 'trackers']  # noqa: E501
        ...
        if 'custom_entities' in params:
            ...
            collection_formats['customEntities'] = 'multi'  # noqa: E501
        ...
        if 'channel_metadata' in params:
            ...
            collection_formats['channelMetadata'] = 'multi'  # noqa: E501
    ...
    def append_audio_with_http_info(self, body, content_type, conversation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'content_type', 'conversation_id', 'name', 'webhook_url', 'custom_vocabulary', 'confidence_threshold', 'custom_entities', 'detect_entities', 'detect_phrases', 'enable_separate_recognition_per_channel', 'channel_metadata', 'language_code', 'mode', 'trackers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
