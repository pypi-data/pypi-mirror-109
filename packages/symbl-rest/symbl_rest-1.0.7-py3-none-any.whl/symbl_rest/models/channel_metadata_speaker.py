...
class ChannelMetadataSpeaker(object):
    ...
    def __init__(self, name=None, email=None):  # noqa: E501
        """ChannelMetadataSpeaker - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._email = None
    ...
    @property
    def name(self):
        """Gets the name of this ChannelMetadataSpeaker.  # noqa: E501


        :return: The name of this ChannelMetadataSpeaker.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ChannelMetadataSpeaker.


        :param name: The name of this ChannelMetadataSpeaker.  # noqa: E501
        :type: str
        """
    ...
    @property
    def email(self):
        """Gets the email of this ChannelMetadataSpeaker.  # noqa: E501


        :return: The email of this ChannelMetadataSpeaker.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this ChannelMetadataSpeaker.


        :param email: The email of this ChannelMetadataSpeaker.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChannelMetadataSpeaker, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChannelMetadataSpeaker):
            return False
