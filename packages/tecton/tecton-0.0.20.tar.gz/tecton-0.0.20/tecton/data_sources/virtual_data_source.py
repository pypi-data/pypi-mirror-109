...
class VirtualDataSource:
    ...
    TemporalFeaturePackages and TemporalAggregateFeaturePackages ingest data from VDS's. A VDS can represent a batch data source,
    ...
    def __init__(
        ...
        *,
        ...
        :param batch_ds_config: BatchDataSourceConfig object containing the configuration of the batch data source that is to be included
            into this VirtualDataSource.
        :param stream_ds_config: (Optional) StreamDataSourceConfig object containing the configuration about the
            batch data source that is to be included included into this virtual DS. If present, this VDS class
...
class BatchDataSource(VirtualDataSource):
    """
    Declare a BatchDataSource (VDS), used to read data into Tecton.
...
class StreamDataSource(VirtualDataSource):
    """
    Declare a StreamDataSource, used to read data into Tecton.

    StreamDataSource is Tecton's main data abstraction.
    ...
    def __init__(
        ...
        *,
        ...
        :param batch_ds_config: BatchDataSourceConfig object containing the configuration of the batch data source that is to be included
            into this DataSource.
        :param stream_ds_config: StreamDataSourceConfig object containing the configuration about the
            batch data source that is to be included included into this DataSource
        :param owner: Owner name.
