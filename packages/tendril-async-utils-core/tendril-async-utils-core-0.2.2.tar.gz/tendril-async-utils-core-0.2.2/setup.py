...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-async-utils-core',
    project_urls={
        'Documentation': 'https://tendril-async-utils-core.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-async-utils-core/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-async-utils-core',
    },
