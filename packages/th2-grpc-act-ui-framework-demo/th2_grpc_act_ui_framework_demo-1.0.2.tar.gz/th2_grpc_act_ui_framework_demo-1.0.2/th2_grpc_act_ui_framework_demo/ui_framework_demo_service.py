from . import ui_framework_demo_pb2_grpc as importStub
...
class UIFrameworkActService(object):
    ...
    def extractOrderDetails(self, request, timeout=None):
        return self.connector.create_request('extractOrderDetails', request, timeout)
