...
def quadkeys(dataset: rasterio.DatasetReader, z: int,
             nodata: Optional[Union[int, float]] = None,
             tile_filter_fn: Optional[Callable[[mercantile.Tile], bool]] = None):
    ...
    with rasterio.vrt.WarpedVRT(dataset, crs="EPSG:3857", **kwargs) as vrt:
        ...
        for tile in tiles:
            ...
            logging.debug("Reading quadkey tile data")
