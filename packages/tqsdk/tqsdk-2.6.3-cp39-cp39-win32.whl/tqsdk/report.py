...
class TqReport(object):
    ...
    def __init__(self, report_id: str, account_df: DataFrame, trade_df: DataFrame):
        ...
        # default metrics
        self.account_df['profit'] = self.account_df['balance'] - self.account_df['pre_balance']  # 每日收益
        ...
        self.account_df['daily_yield'] = self.account_df['balance'] / self.account_df['pre_balance'] - 1  # 每日收益率
