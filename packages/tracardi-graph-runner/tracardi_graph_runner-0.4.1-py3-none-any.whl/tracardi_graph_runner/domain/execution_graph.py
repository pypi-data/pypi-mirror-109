...
from ..utils.dot_accessor import DotAccessor
...
class ExecutionGraph(BaseModel):
    ...
    def init(self, flow, flow_history, event, session, profile, debug=False) -> InitResult:
        errors = []
        objects = []
        for node in self.graph:
            ...
            try:
                ...
                node.object.dot = DotAccessor(session=session, profile=profile, event=event, payload={})
