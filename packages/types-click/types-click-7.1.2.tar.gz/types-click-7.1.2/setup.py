...
This is an auto-generated PEP 561 type stub package for `click` package.
...
setup(name=name,
      ...
      package_data={'click-stubs': ['types.pyi', 'globals.pyi', 'utils.pyi', 'exceptions.pyi', '_termui_impl.pyi', 'core.pyi', 'termui.pyi', 'parser.pyi', '__init__.pyi', 'formatting.pyi', 'testing.pyi', 'decorators.pyi', 'METADATA.toml']},
