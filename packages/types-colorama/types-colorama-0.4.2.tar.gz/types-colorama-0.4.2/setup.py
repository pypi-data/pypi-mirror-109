...
This is an auto-generated PEP 561 type stub package for `colorama` package.
...
setup(name=name,
      ...
      package_data={'colorama-stubs': ['ansi.pyi', 'winterm.pyi', 'ansitowin32.pyi', 'initialise.pyi', 'win32.pyi', '__init__.pyi', 'METADATA.toml']},
