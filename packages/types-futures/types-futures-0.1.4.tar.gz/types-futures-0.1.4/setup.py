...
setup(name=name,
      ...
      install_requires=[],
      packages=['concurrent-stubs'],
      package_data={'concurrent-stubs': ['__init__.pyi', 'futures/thread.pyi', 'futures/_base.pyi', 'futures/process.pyi', 'futures/__init__.pyi', 'METADATA.toml']},
