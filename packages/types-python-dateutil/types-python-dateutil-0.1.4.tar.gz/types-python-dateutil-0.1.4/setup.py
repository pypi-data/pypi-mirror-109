...
This is an auto-generated PEP 561 type stub package for `python-dateutil` package.
...
setup(name=name,
      ...
      package_data={'dateutil-stubs': ['utils.pyi', 'relativedelta.pyi', '_common.pyi', 'parser.pyi', 'easter.pyi', 'rrule.pyi', '__init__.pyi', 'tz/tz.pyi', 'tz/_common.pyi', 'tz/__init__.pyi', 'METADATA.toml']},
