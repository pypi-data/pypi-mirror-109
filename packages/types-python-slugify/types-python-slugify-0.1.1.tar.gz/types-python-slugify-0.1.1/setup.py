...
This is an auto-generated PEP 561 type stub package for `python-slugify` package.
...
setup(name=name,
      ...
      package_data={'slugify-stubs': ['special.pyi', 'slugify.pyi', '__init__.pyi', 'METADATA.toml']},
