...
This is an auto-generated PEP 561 type stub package for `typed-ast` package.
...
setup(name=name,
      ...
      package_data={'typed_ast-stubs': ['ast3.pyi', 'conversions.pyi', 'ast27.pyi', '__init__.pyi', 'METADATA.toml']},
