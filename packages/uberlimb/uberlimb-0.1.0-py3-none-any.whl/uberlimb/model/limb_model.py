...
from uberlimb.model.models_impl import architecture_lookup, ModelArchitecture
from uberlimb.parameters import ModelParams


class LimbModel:
    @classmethod
    @validate_arguments
    def get_model(cls, params: ModelParams) -> tf.keras.Model:
