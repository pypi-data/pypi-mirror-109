...
def model_test(x_test, x_test_normal, y_test, models_path: List, models_name: List, savename: str,
    ...
    for i in range(len(models_name)):
        evaluate = Evaluation(model_name=models_name[i], y_true=y_trues[i], y_pred=y_preds[i], lables=[1, 0])
