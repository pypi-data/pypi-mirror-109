...
stable = {"adr": ["p-street-address", "p-extended-address",
          ...
          "card": ["p-name", "p-honorific-prefix", "p-given-name",
                   ...
                   "p-tel", "p-note", "dt-bday", "u-key", "p-org",
                   "p-job-title", "p-role", "u-impp", "p-sex",
                   "p-gender-identity", "dt-anniversary"],
          "entry": ["p-name", "p-summary", "e-content", "dt-published",
                    "dt-updated", "p-author", "p-category", "u-url",
                    "u-uid", "p-location", "u-syndication", "u-in-reply-to",
          ...
          "resume": ["p-name", "p-summary", "p-contact",
                     "p-education(event+card)", "p-experience(event+card)",
                     "p-skill", "p-affiliation"],
          "review": ["p-name ", "p-item(card/event/adr/geo/product/item)",
...
def representative_card(parsed, source_url):
    ...
    cards = [h for h in util.find_all_entries(parsed, ['h-card'],
    ...
    for card in cards:
        if (source_url in get_normal(card, "uid")
                and source_url in get_normal(card, "url")):
