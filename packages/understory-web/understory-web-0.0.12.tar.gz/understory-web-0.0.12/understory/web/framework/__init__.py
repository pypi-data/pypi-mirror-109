...
def application(name, *wrappers, prefix=r"", mount_prefix=r"",
                db=True, host=None, static=None, icon=None, sessions=False,
...
def serve(wsgi_app, workers=2):
    ...
    proc = sh.gunicorn(wsgi_app, bind="0.0.0.0:8100",
                       worker_class="gevent", workers=workers,
                       _bg=True, _err=process, _out=process)
    # if watch:
