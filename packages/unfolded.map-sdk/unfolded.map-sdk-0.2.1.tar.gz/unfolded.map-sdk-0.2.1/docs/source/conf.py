...
latex_documents = [
    (
        master_doc, 'unfolded_jupyter.tex', 'unfolded_jupyter Documentation',
        'Unfolded Inc.', 'manual'), ]
...
man_pages = [(
    master_doc, 'unfolded_jupyter', 'unfolded_jupyter Documentation', [
        author], 1)]
...
texinfo_documents = [
    (
        master_doc, 'unfolded_jupyter', 'unfolded_jupyter Documentation',
        author, 'unfolded_jupyter', 'A Custom Jupyter Widget Library',
        'Miscellaneous'), ]
