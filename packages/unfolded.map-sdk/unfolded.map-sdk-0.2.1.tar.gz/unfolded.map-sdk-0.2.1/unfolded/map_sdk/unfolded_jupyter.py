...
class UnfoldedMap(DOMWidget):
    ...
    width = TraitletsUnion([Unicode(), Int()],
                           allow_none=True,
                           default_value='100%').tag(sync=True)
    height = TraitletsUnion([Unicode(), Int()],
                            allow_none=True,
                            default_value='100%').tag(sync=True)
    ...
    def __init__(
            ...
            on_timeline_interval_change: models.
        OnTimelineIntervalChangeHandlerType = None,
            on_layer_timeline_time_change: models.
        OnLayerTimelineTimeChangeHandlerType = None,
    ...
    def add_dataset(
            ...
            auto_create_layers: bool = True) -> Future:
    ...
    def set_map_event_handlers(
            self, event_handlers: Optional[models.MapEventHandlers]) -> None:
        ...
        if event_handlers is None:
            ...
            update = event_handlers.dict() if isinstance(
                event_handlers, models.MapEventHandlers) else event_handlers
            self.map_event_handlers = self.map_event_handlers.copy(
                update=update)
