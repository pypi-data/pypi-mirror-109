...
class StrategyBacktestStats(Model):
    stg_info_id: int = IntegerField(help_text="StrategyInfo 信息")
    symbols_info_id: int = IntegerField(help_text="SymbolsInfo 信息")
    id_name: str = CharField(max_length=300, help_text="生成相关图片等文件时使用的文件名头部标示")
        ...
        try:
            ...
            if old_id_name is not None and old_id_name != statistics['id_name']:
                ...
                StrategyBacktestStats.delete().where(
                    StrategyBacktestStats.symbols_info_id == symbols_info,
                    StrategyBacktestStats.stg_info_id == stg_info,
