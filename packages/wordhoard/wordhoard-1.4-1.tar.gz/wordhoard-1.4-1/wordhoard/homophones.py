...
try:
    _file_known_homophones = os.path.abspath('wordhoard/files/common_english_homophones.pkl')
...
try:
    _file_no_known_homophones = os.path.abspath('wordhoard/files/no_homophones_english.pkl')
