...
try:
    _file_known_homophones = os.path.join(PARENT_DIRECTORY, 'files/pickle_files/common_english_homophones.pkl')
...
try:
    _file_no_known_homophones = os.path.join(PARENT_DIRECTORY, 'files/pickle_files/no_homophones_english.pkl')
