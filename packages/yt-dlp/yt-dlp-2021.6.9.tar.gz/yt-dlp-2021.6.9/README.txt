...
-   MERGED WITH YOUTUBE-DL COMMIT/C2350CA: (v2021.06.06) You get all the
...
various data. Licenced under BSD2 * ATOMICPARSLEY - For embedding
thumbnail in mp4/m4a if mutagen is not present. Licenced under GPLv2+ *
RTMPDUMP - For downloading rtmp streams. ffmpeg will be used as a
fallback. Licenced under GPLv2+ * MPLAYER or MPV - For downloading rstp
streams. ffmpeg will be used as a fallback. Licenced under GPLv2+ *
PHANTOMJS - Used in extractors where javascript needs to be run.
Licenced under BSD3 * Any external downloader that you want to use with
--downloader
...
interpreter, mutagen and pycryptodome included.
